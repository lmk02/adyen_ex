defmodule Adyen.Checkout.V52.Modifications do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_cancels(
          body :: Adyen.Checkout.V52.StandalonePaymentCancelRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V52.StandalonePaymentCancelResponse.t()}
          | {:error, Adyen.Checkout.V52.ServiceError.t()}
  def post_cancels(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V52.Modifications, :post_cancels},
      url: "/cancels",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V52.StandalonePaymentCancelRequest, :t}}],
      response: [
        {201, {Adyen.Checkout.V52.StandalonePaymentCancelResponse, :t}},
        {400, {Adyen.Checkout.V52.ServiceError, :t}},
        {401, {Adyen.Checkout.V52.ServiceError, :t}},
        {403, {Adyen.Checkout.V52.ServiceError, :t}},
        {422, {Adyen.Checkout.V52.ServiceError, :t}},
        {500, {Adyen.Checkout.V52.ServiceError, :t}}
      ],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_payment_psp_reference_amount_updates(
          ...
          body :: Adyen.Checkout.V52.PaymentAmountUpdateRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V52.PaymentAmountUpdateResponse.t()}
          | {:error, Adyen.Checkout.V52.ServiceError.t()}
  def post_payments_payment_psp_reference_amount_updates(paymentPspReference, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.Checkout.V52.Modifications, :post_payments_payment_psp_reference_amount_updates},
      url: "/payments/#{paymentPspReference}/amountUpdates",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V52.PaymentAmountUpdateRequest, :t}}],
      response: [
        {201, {Adyen.Checkout.V52.PaymentAmountUpdateResponse, :t}},
        {400, {Adyen.Checkout.V52.ServiceError, :t}},
        {401, {Adyen.Checkout.V52.ServiceError, :t}},
        {403, {Adyen.Checkout.V52.ServiceError, :t}},
        {422, {Adyen.Checkout.V52.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_payment_psp_reference_cancels(
          paymentPspReference :: String.t(),
          body :: Adyen.Checkout.V52.PaymentCancelRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V52.PaymentCancelResponse.t()}
          | {:error, Adyen.Checkout.V52.ServiceError.t()}
  def post_payments_payment_psp_reference_cancels(paymentPspReference, body, opts \\ []) do
    ...
    client.request(%{
      args: [paymentPspReference: paymentPspReference, body: body],
      call: {Adyen.Checkout.V52.Modifications, :post_payments_payment_psp_reference_cancels},
      url: "/payments/#{paymentPspReference}/cancels",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V52.PaymentCancelRequest, :t}}],
      response: [
        {201, {Adyen.Checkout.V52.PaymentCancelResponse, :t}},
        {400, {Adyen.Checkout.V52.ServiceError, :t}},
        {401, {Adyen.Checkout.V52.ServiceError, :t}},
        {403, {Adyen.Checkout.V52.ServiceError, :t}},
        {422, {Adyen.Checkout.V52.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_payment_psp_reference_captures(
          paymentPspReference :: String.t(),
          body :: Adyen.Checkout.V52.PaymentCaptureRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V52.PaymentCaptureResponse.t()}
          | {:error, Adyen.Checkout.V52.ServiceError.t()}
  def post_payments_payment_psp_reference_captures(paymentPspReference, body, opts \\ []) do
    ...
    client.request(%{
      args: [paymentPspReference: paymentPspReference, body: body],
      call: {Adyen.Checkout.V52.Modifications, :post_payments_payment_psp_reference_captures},
      url: "/payments/#{paymentPspReference}/captures",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V52.PaymentCaptureRequest, :t}}],
      response: [
        {201, {Adyen.Checkout.V52.PaymentCaptureResponse, :t}},
        {400, {Adyen.Checkout.V52.ServiceError, :t}},
        {401, {Adyen.Checkout.V52.ServiceError, :t}},
        {403, {Adyen.Checkout.V52.ServiceError, :t}},
        {422, {Adyen.Checkout.V52.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_payment_psp_reference_refunds(
          paymentPspReference :: String.t(),
          body :: Adyen.Checkout.V52.PaymentRefundRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V52.PaymentRefundResponse.t()}
          | {:error, Adyen.Checkout.V52.ServiceError.t()}
  def post_payments_payment_psp_reference_refunds(paymentPspReference, body, opts \\ []) do
    ...
    client.request(%{
      args: [paymentPspReference: paymentPspReference, body: body],
      call: {Adyen.Checkout.V52.Modifications, :post_payments_payment_psp_reference_refunds},
      url: "/payments/#{paymentPspReference}/refunds",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V52.PaymentRefundRequest, :t}}],
      response: [
        {201, {Adyen.Checkout.V52.PaymentRefundResponse, :t}},
        {400, {Adyen.Checkout.V52.ServiceError, :t}},
        {401, {Adyen.Checkout.V52.ServiceError, :t}},
        {403, {Adyen.Checkout.V52.ServiceError, :t}},
        {422, {Adyen.Checkout.V52.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_payment_psp_reference_reversals(
          paymentPspReference :: String.t(),
          body :: Adyen.Checkout.V52.PaymentReversalRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V52.PaymentReversalResponse.t()}
          | {:error, Adyen.Checkout.V52.ServiceError.t()}
  def post_payments_payment_psp_reference_reversals(paymentPspReference, body, opts \\ []) do
    ...
    client.request(%{
      args: [paymentPspReference: paymentPspReference, body: body],
      call: {Adyen.Checkout.V52.Modifications, :post_payments_payment_psp_reference_reversals},
      url: "/payments/#{paymentPspReference}/reversals",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V52.PaymentReversalRequest, :t}}],
      response: [
        {201, {Adyen.Checkout.V52.PaymentReversalResponse, :t}},
        {400, {Adyen.Checkout.V52.ServiceError, :t}},
        {401, {Adyen.Checkout.V52.ServiceError, :t}},
        {403, {Adyen.Checkout.V52.ServiceError, :t}},
        {422, {Adyen.Checkout.V52.ServiceError, :t}},
