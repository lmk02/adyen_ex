defmodule AdyenEx.Checkout.V52.Recurring do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_forward(body :: AdyenEx.Checkout.V52.CheckoutForwardRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V52.CheckoutForwardResponse.t()} | :error
  def post_forward(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V52.Recurring, :post_forward},
      url: "/forward",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V52.CheckoutForwardRequest, :t}}],
      response: [{200, {AdyenEx.Checkout.V52.CheckoutForwardResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  ...
  @spec post_stored_payment_methods(
          body :: AdyenEx.Checkout.V52.StoredPaymentMethodRequest.t(),
          opts :: keyword
        ) :: {:ok, AdyenEx.Checkout.V52.StoredPaymentMethodResource.t()} | :error
  def post_stored_payment_methods(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V52.Recurring, :post_stored_payment_methods},
      url: "/storedPaymentMethods",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V52.StoredPaymentMethodRequest, :t}}],
      response: [{201, {AdyenEx.Checkout.V52.StoredPaymentMethodResource, :t}}],
      opts: opts
    })
  end
