defmodule AdyenEx.Checkout.V52.CheckoutForwardRequestOptions do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          dryRun: boolean | nil,
          networkToken: AdyenEx.Checkout.V52.CheckoutNetworkTokenOption.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      dryRun: :boolean,
      networkToken: {AdyenEx.Checkout.V52.CheckoutNetworkTokenOption, :t},
