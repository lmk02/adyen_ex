defmodule AdyenEx.Checkout.V52.PixRecurring do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          minAmount: AdyenEx.Checkout.V52.Amount.t() | nil,
          originalPspReference: String.t() | nil,
          recurringAmount: AdyenEx.Checkout.V52.Amount.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      minAmount: {AdyenEx.Checkout.V52.Amount, :t},
      originalPspReference: :string,
      recurringAmount: {AdyenEx.Checkout.V52.Amount, :t},
