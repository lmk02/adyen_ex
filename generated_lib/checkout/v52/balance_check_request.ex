defmodule AdyenEx.Checkout.V52.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: map,
          recurring: AdyenEx.Checkout.V52.Recurring.t() | nil,
          ...
          threeDS2RequestData: AdyenEx.Checkout.V52.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: :map,
      recurring: {AdyenEx.Checkout.V52.Recurring, :t},
      ...
      threeDS2RequestData: {AdyenEx.Checkout.V52.ThreeDs2RequestData, :t},
