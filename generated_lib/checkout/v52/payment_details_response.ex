defmodule AdyenEx.Checkout.V52.PaymentDetailsResponse do
  @moduledoc """
  Provides struct and type for a PaymentDetailsResponse
  """

  @type t :: %__MODULE__{
          action: AdyenEx.Checkout.V52.CheckoutRedirectAction.t() | nil,
  ...
  def __fields__(:t) do
    [
      action: {AdyenEx.Checkout.V52.CheckoutRedirectAction, :t},
      additionalData: :map,
