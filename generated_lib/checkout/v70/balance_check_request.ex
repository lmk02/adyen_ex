defmodule AdyenEx.Checkout.V70.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          deliveryAddress: AdyenEx.Checkout.V70.Address.t() | nil,
          ...
          paymentMethod: map,
          recurring: AdyenEx.Checkout.V70.Recurring.t() | nil,
          ...
          threeDS2RequestData: AdyenEx.Checkout.V70.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      deliveryAddress: {AdyenEx.Checkout.V70.Address, :t},
      ...
      paymentMethod: :map,
      recurring: {AdyenEx.Checkout.V70.Recurring, :t},
      ...
      threeDS2RequestData: {AdyenEx.Checkout.V70.ThreeDs2RequestData, :t},
