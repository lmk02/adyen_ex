defmodule AdyenEx.Checkout.V70.Lodging do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          folio: AdyenEx.Checkout.V70.Folio.t() | nil,
          ...
          rooms: [AdyenEx.Checkout.V70.Room.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      folio: {AdyenEx.Checkout.V70.Folio, :t},
      ...
      renterName: :string,
      rooms: [{AdyenEx.Checkout.V70.Room, :t}],
