defmodule AdyenEx.Checkout.V70.CarRental do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          noShow: boolean | nil,
          pickupInfo: AdyenEx.Checkout.V70.PickupInfo.t() | nil,
          ...
          rentalSurcharges: AdyenEx.Checkout.V70.RentalSurcharges.t() | nil,
          renterName: String.t(),
          returnInfo: AdyenEx.Checkout.V70.ReturnInfo.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      noShow: :boolean,
      pickupInfo: {AdyenEx.Checkout.V70.PickupInfo, :t},
      ...
      rentalSurcharges: {AdyenEx.Checkout.V70.RentalSurcharges, :t},
      renterName: :string,
      returnInfo: {AdyenEx.Checkout.V70.ReturnInfo, :t},
      taxExempt: :boolean
    ]
  end
end
