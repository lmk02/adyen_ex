defmodule AdyenEx.Checkout.V70.ThreeDs2RequestFields do
  @moduledoc """
  Provides struct and type for a ThreeDs2RequestFields
  """

  @type t :: %__MODULE__{
          acctInfo: AdyenEx.Checkout.V70.AcctInfo.t() | nil,
          ...
          deviceRenderOptions: AdyenEx.Checkout.V70.DeviceRenderOptions.t() | nil,
          homePhone: AdyenEx.Checkout.V70.Phone.t() | nil,
          mcc: String.t() | nil,
          merchantName: String.t() | nil,
          messageVersion: String.t() | nil,
          mobilePhone: AdyenEx.Checkout.V70.Phone.t() | nil,
          ...
          sdkEphemPubKey: AdyenEx.Checkout.V70.SDKEphemPubKey.t() | nil,
  ...
  def __fields__(:t) do
    [
      acctInfo: {AdyenEx.Checkout.V70.AcctInfo, :t},
      ...
      deviceRenderOptions: {AdyenEx.Checkout.V70.DeviceRenderOptions, :t},
      homePhone: {AdyenEx.Checkout.V70.Phone, :t},
      mcc: :string,
      merchantName: :string,
      messageVersion: :string,
      mobilePhone: {AdyenEx.Checkout.V70.Phone, :t},
      ...
      sdkAppID: :string,
      sdkEphemPubKey: {AdyenEx.Checkout.V70.SDKEphemPubKey, :t},
      ...
      threeDSRequestorAuthenticationInfo:
        {AdyenEx.Checkout.V70.ThreeDSRequestorAuthenticationInfo, :t},
      threeDSRequestorChallengeInd: {:enum, ["01", "02", "03", "04", "05", "06"]},
      threeDSRequestorID: :string,
      threeDSRequestorName: :string,
      threeDSRequestorPriorAuthenticationInfo:
        {AdyenEx.Checkout.V70.ThreeDSRequestorPriorAuthenticationInfo, :t},
      ...
      workPhone: {AdyenEx.Checkout.V70.Phone, :t}
    ]
  end
end
