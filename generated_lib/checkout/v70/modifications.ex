defmodule AdyenEx.Checkout.V70.Modifications do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_cancels(
          body :: AdyenEx.Checkout.V70.StandalonePaymentCancelRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V70.StandalonePaymentCancelResponse.t()}
  ...
  def post_cancels(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V70.Modifications, :post_cancels},
      url: "/cancels",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V70.StandalonePaymentCancelRequest, :t}}],
      response: [
        {201, {AdyenEx.Checkout.V70.StandalonePaymentCancelResponse, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_payment_psp_reference_amount_updates(
          ...
          body :: AdyenEx.Checkout.V70.PaymentAmountUpdateRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V70.PaymentAmountUpdateResponse.t()}
          | {:error, AdyenEx.Checkout.V70.ServiceError.t()}
  def post_payments_payment_psp_reference_amount_updates(paymentPspReference, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.Checkout.V70.Modifications, :post_payments_payment_psp_reference_amount_updates},
      url: "/payments/#{paymentPspReference}/amountUpdates",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V70.PaymentAmountUpdateRequest, :t}}],
      response: [
        {201, {AdyenEx.Checkout.V70.PaymentAmountUpdateResponse, :t}},
        {400, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V70.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_payment_psp_reference_cancels(
          paymentPspReference :: String.t(),
          body :: AdyenEx.Checkout.V70.PaymentCancelRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V70.PaymentCancelResponse.t()}
          | {:error, AdyenEx.Checkout.V70.ServiceError.t()}
  def post_payments_payment_psp_reference_cancels(paymentPspReference, body, opts \\ []) do
    ...
    client.request(%{
      args: [paymentPspReference: paymentPspReference, body: body],
      call: {AdyenEx.Checkout.V70.Modifications, :post_payments_payment_psp_reference_cancels},
      url: "/payments/#{paymentPspReference}/cancels",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V70.PaymentCancelRequest, :t}}],
      response: [
        {201, {AdyenEx.Checkout.V70.PaymentCancelResponse, :t}},
        {400, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V70.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_payment_psp_reference_captures(
          paymentPspReference :: String.t(),
          body :: AdyenEx.Checkout.V70.PaymentCaptureRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V70.PaymentCaptureResponse.t()}
          | {:error, AdyenEx.Checkout.V70.ServiceError.t()}
  def post_payments_payment_psp_reference_captures(paymentPspReference, body, opts \\ []) do
    ...
    client.request(%{
      args: [paymentPspReference: paymentPspReference, body: body],
      call: {AdyenEx.Checkout.V70.Modifications, :post_payments_payment_psp_reference_captures},
      url: "/payments/#{paymentPspReference}/captures",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V70.PaymentCaptureRequest, :t}}],
      response: [
        {201, {AdyenEx.Checkout.V70.PaymentCaptureResponse, :t}},
        {400, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V70.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_payment_psp_reference_refunds(
          paymentPspReference :: String.t(),
          body :: AdyenEx.Checkout.V70.PaymentRefundRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V70.PaymentRefundResponse.t()}
          | {:error, AdyenEx.Checkout.V70.ServiceError.t()}
  def post_payments_payment_psp_reference_refunds(paymentPspReference, body, opts \\ []) do
    ...
    client.request(%{
      args: [paymentPspReference: paymentPspReference, body: body],
      call: {AdyenEx.Checkout.V70.Modifications, :post_payments_payment_psp_reference_refunds},
      url: "/payments/#{paymentPspReference}/refunds",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V70.PaymentRefundRequest, :t}}],
      response: [
        {201, {AdyenEx.Checkout.V70.PaymentRefundResponse, :t}},
        {400, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V70.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_payment_psp_reference_reversals(
          paymentPspReference :: String.t(),
          body :: AdyenEx.Checkout.V70.PaymentReversalRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V70.PaymentReversalResponse.t()}
          | {:error, AdyenEx.Checkout.V70.ServiceError.t()}
  def post_payments_payment_psp_reference_reversals(paymentPspReference, body, opts \\ []) do
    ...
    client.request(%{
      args: [paymentPspReference: paymentPspReference, body: body],
      call: {AdyenEx.Checkout.V70.Modifications, :post_payments_payment_psp_reference_reversals},
      url: "/payments/#{paymentPspReference}/reversals",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V70.PaymentReversalRequest, :t}}],
      response: [
        {201, {AdyenEx.Checkout.V70.PaymentReversalResponse, :t}},
        {400, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V70.ServiceError, :t}},
