defmodule AdyenEx.Checkout.V70.Orders do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_orders(body :: AdyenEx.Checkout.V70.CreateOrderRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V70.CreateOrderResponse.t()}
  ...
  def post_orders(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V70.Orders, :post_orders},
      url: "/orders",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V70.CreateOrderRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V70.CreateOrderResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_orders_cancel(body :: AdyenEx.Checkout.V70.CancelOrderRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V70.CancelOrderResponse.t()}
          | {:error, AdyenEx.Checkout.V70.ServiceError.t()}
  def post_orders_cancel(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V70.Orders, :post_orders_cancel},
      url: "/orders/cancel",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V70.CancelOrderRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V70.CancelOrderResponse, :t}},
        {400, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V70.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payment_methods_balance(
          body :: AdyenEx.Checkout.V70.BalanceCheckRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V70.BalanceCheckResponse.t()}
          | {:error, AdyenEx.Checkout.V70.ServiceError.t()}
  def post_payment_methods_balance(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V70.Orders, :post_payment_methods_balance},
      url: "/paymentMethods/balance",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V70.BalanceCheckRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V70.BalanceCheckResponse, :t}},
        {400, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V70.ServiceError, :t}},
