defmodule AdyenEx.Checkout.V70.Payments do
  @moduledoc """
  ...
  @spec get_sessions_session_id(sessionId :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V70.SessionResultResponse.t()} | :error
  def get_sessions_session_id(sessionId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.Checkout.V70.Payments, :get_sessions_session_id},
      url: "/sessions/#{sessionId}",
      method: :get,
      query: query,
      response: [{200, {AdyenEx.Checkout.V70.SessionResultResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  """
  @spec post_card_details(body :: AdyenEx.Checkout.V70.CardDetailsRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V70.CardDetailsResponse.t()} | :error
  def post_card_details(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V70.Payments, :post_card_details},
      url: "/cardDetails",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V70.CardDetailsRequest, :t}}],
      response: [{200, {AdyenEx.Checkout.V70.CardDetailsResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payment_methods(
          body :: AdyenEx.Checkout.V70.PaymentMethodsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V70.PaymentMethodsResponse.t()}
  ...
  def post_payment_methods(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V70.Payments, :post_payment_methods},
      url: "/paymentMethods",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V70.PaymentMethodsRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V70.PaymentMethodsResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_payments(body :: AdyenEx.Checkout.V70.PaymentRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V70.PaymentResponse.t()}
          | {:error, AdyenEx.Checkout.V70.ServiceError.t()}
  def post_payments(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V70.Payments, :post_payments},
      url: "/payments",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V70.PaymentRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V70.PaymentResponse, :t}},
        {400, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V70.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_details(
          body :: AdyenEx.Checkout.V70.PaymentDetailsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V70.PaymentDetailsResponse.t()}
          | {:error, AdyenEx.Checkout.V70.ServiceError.t()}
  def post_payments_details(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V70.Payments, :post_payments_details},
      url: "/payments/details",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V70.PaymentDetailsRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V70.PaymentDetailsResponse, :t}},
        {400, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V70.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V70.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_sessions(
          body :: AdyenEx.Checkout.V70.CreateCheckoutSessionRequest.t(),
          opts :: keyword
        ) :: {:ok, AdyenEx.Checkout.V70.CreateCheckoutSessionResponse.t()} | :error
  def post_sessions(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V70.Payments, :post_sessions},
      url: "/sessions",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V70.CreateCheckoutSessionRequest, :t}}],
      response: [{201, {AdyenEx.Checkout.V70.CreateCheckoutSessionResponse, :t}}],
      opts: opts
    })
  end
end
