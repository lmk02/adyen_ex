defmodule AdyenEx.Checkout.V40.RecurringDetail do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          storedDetails: AdyenEx.Checkout.V40.StoredDetails.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      storedDetails: {AdyenEx.Checkout.V40.StoredDetails, :t},
