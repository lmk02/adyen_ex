defmodule Adyen.Checkout.V40.Payments do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_card_details(body :: Adyen.Checkout.V40.CardDetailsRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V40.CardDetailsResponse.t()} | :error
  def post_card_details(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V40.Payments, :post_card_details},
      url: "/cardDetails",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V40.CardDetailsRequest, :t}}],
      response: [{200, {Adyen.Checkout.V40.CardDetailsResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payment_methods(
          body :: Adyen.Checkout.V40.PaymentMethodsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V40.PaymentMethodsResponse.t()}
  ...
  def post_payment_methods(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V40.Payments, :post_payment_methods},
      url: "/paymentMethods",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V40.PaymentMethodsRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V40.PaymentMethodsResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_payments(body :: Adyen.Checkout.V40.PaymentRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V40.PaymentResponse.t()}
          | {:error, Adyen.Checkout.V40.ServiceError.t()}
  def post_payments(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V40.Payments, :post_payments},
      url: "/payments",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V40.PaymentRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V40.PaymentResponse, :t}},
        {400, {Adyen.Checkout.V40.ServiceError, :t}},
        {401, {Adyen.Checkout.V40.ServiceError, :t}},
        {403, {Adyen.Checkout.V40.ServiceError, :t}},
        {422, {Adyen.Checkout.V40.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_details(
          body :: Adyen.Checkout.V40.PaymentDetailsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V40.PaymentDetailsResponse.t()}
          | {:error, Adyen.Checkout.V40.ServiceError.t()}
  def post_payments_details(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V40.Payments, :post_payments_details},
      url: "/payments/details",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V40.PaymentDetailsRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V40.PaymentDetailsResponse, :t}},
        {400, {Adyen.Checkout.V40.ServiceError, :t}},
        {401, {Adyen.Checkout.V40.ServiceError, :t}},
        {403, {Adyen.Checkout.V40.ServiceError, :t}},
        {422, {Adyen.Checkout.V40.ServiceError, :t}},
