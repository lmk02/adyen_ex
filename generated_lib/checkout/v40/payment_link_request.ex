defmodule AdyenEx.Checkout.V40.PaymentLinkRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          metadata: map | nil,
          platformChargebackLogic: AdyenEx.Checkout.V40.PlatformChargebackLogic.t() | nil,
          ...
          store: String.t() | nil,
          threeDS2RequestData: AdyenEx.Checkout.V40.CheckoutSessionThreeDs2RequestData.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      metadata: :map,
      platformChargebackLogic: {AdyenEx.Checkout.V40.PlatformChargebackLogic, :t},
      ...
      store: :string,
      threeDS2RequestData: {AdyenEx.Checkout.V40.CheckoutSessionThreeDs2RequestData, :t}
    ]
  end
end
