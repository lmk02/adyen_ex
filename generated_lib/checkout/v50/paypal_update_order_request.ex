defmodule AdyenEx.Checkout.V50.PaypalUpdateOrderRequest do
  ...
  @type t :: %__MODULE__{
          ...
          discountAmount: AdyenEx.Checkout.V50.Amount.t() | nil,
          paymentData: String.t() | nil,
          pspReference: String.t() | nil,
          sessionId: String.t() | nil,
          shippingAmount: AdyenEx.Checkout.V50.Amount.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      discountAmount: {AdyenEx.Checkout.V50.Amount, :t},
      paymentData: :string,
      pspReference: :string,
      sessionId: :string,
      shippingAmount: {AdyenEx.Checkout.V50.Amount, :t},
