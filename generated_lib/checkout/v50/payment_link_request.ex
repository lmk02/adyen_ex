defmodule AdyenEx.Checkout.V50.PaymentLinkRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          metadata: map | nil,
          platformChargebackLogic: AdyenEx.Checkout.V50.PlatformChargebackLogic.t() | nil,
          ...
          threeDS2RequestData: AdyenEx.Checkout.V50.CheckoutSessionThreeDs2RequestData.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      metadata: :map,
      platformChargebackLogic: {AdyenEx.Checkout.V50.PlatformChargebackLogic, :t},
      ...
      threeDS2RequestData: {AdyenEx.Checkout.V50.CheckoutSessionThreeDs2RequestData, :t}
    ]
  end
end
