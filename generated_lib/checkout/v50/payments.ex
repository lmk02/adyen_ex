defmodule Adyen.Checkout.V50.Payments do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_card_details(body :: Adyen.Checkout.V50.CardDetailsRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V50.CardDetailsResponse.t()} | :error
  def post_card_details(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V50.Payments, :post_card_details},
      url: "/cardDetails",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V50.CardDetailsRequest, :t}}],
      response: [{200, {Adyen.Checkout.V50.CardDetailsResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payment_methods(
          body :: Adyen.Checkout.V50.PaymentMethodsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V50.PaymentMethodsResponse.t()}
  ...
  def post_payment_methods(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V50.Payments, :post_payment_methods},
      url: "/paymentMethods",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V50.PaymentMethodsRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V50.PaymentMethodsResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_payments(body :: Adyen.Checkout.V50.PaymentRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V50.PaymentResponse.t()}
          | {:error, Adyen.Checkout.V50.ServiceError.t()}
  def post_payments(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V50.Payments, :post_payments},
      url: "/payments",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V50.PaymentRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V50.PaymentResponse, :t}},
        {400, {Adyen.Checkout.V50.ServiceError, :t}},
        {401, {Adyen.Checkout.V50.ServiceError, :t}},
        {403, {Adyen.Checkout.V50.ServiceError, :t}},
        {422, {Adyen.Checkout.V50.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_details(
          body :: Adyen.Checkout.V50.PaymentDetailsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V50.PaymentDetailsResponse.t()}
          | {:error, Adyen.Checkout.V50.ServiceError.t()}
  def post_payments_details(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V50.Payments, :post_payments_details},
      url: "/payments/details",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V50.PaymentDetailsRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V50.PaymentDetailsResponse, :t}},
        {400, {Adyen.Checkout.V50.ServiceError, :t}},
        {401, {Adyen.Checkout.V50.ServiceError, :t}},
        {403, {Adyen.Checkout.V50.ServiceError, :t}},
        {422, {Adyen.Checkout.V50.ServiceError, :t}},
