defmodule Adyen.Checkout.V50.Donations do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_donations(body :: Adyen.Checkout.V50.DonationPaymentRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V50.DonationPaymentResponse.t()}
  ...
  def post_donations(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V50.Donations, :post_donations},
      url: "/donations",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V50.DonationPaymentRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V50.DonationPaymentResponse, :t}},
