defmodule AdyenEx.Checkout.V66.PaymentLinkRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          billingAddress: AdyenEx.Checkout.V66.Address.t() | nil,
          blockedPaymentMethods: [String.t()] | nil,
          countryCode: String.t() | nil,
          deliverAt: DateTime.t() | nil,
          deliveryAddress: AdyenEx.Checkout.V66.Address.t() | nil,
          ...
          metadata: map | nil,
          platformChargebackLogic: AdyenEx.Checkout.V66.PlatformChargebackLogic.t() | nil,
          ...
          shopperName: AdyenEx.Checkout.V66.Name.t() | nil,
          shopperReference: String.t() | nil,
          showRemovePaymentMethodButton: boolean | nil,
          splits: [AdyenEx.Checkout.V66.Split.t()] | nil,
          store: String.t() | nil,
          storePaymentMethod: boolean | nil,
          threeDS2RequestData: AdyenEx.Checkout.V66.CheckoutSessionThreeDs2RequestData.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      billingAddress: {AdyenEx.Checkout.V66.Address, :t},
      blockedPaymentMethods: [:string],
      countryCode: :string,
      deliverAt: {:string, "date-time"},
      deliveryAddress: {AdyenEx.Checkout.V66.Address, :t},
      description: :string,
      expiresAt: :string,
      ...
      metadata: :map,
      platformChargebackLogic: {AdyenEx.Checkout.V66.PlatformChargebackLogic, :t},
      ...
      shopperName: {AdyenEx.Checkout.V66.Name, :t},
      shopperReference: :string,
      showRemovePaymentMethodButton: :boolean,
      splits: [{AdyenEx.Checkout.V66.Split, :t}],
      store: :string,
      storePaymentMethod: :boolean,
      threeDS2RequestData: {AdyenEx.Checkout.V66.CheckoutSessionThreeDs2RequestData, :t}
    ]
  end
end
