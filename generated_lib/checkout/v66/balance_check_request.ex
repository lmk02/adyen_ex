defmodule AdyenEx.Checkout.V66.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: map,
          recurring: AdyenEx.Checkout.V66.Recurring.t() | nil,
          ...
          threeDS2RequestData: AdyenEx.Checkout.V66.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: :map,
      recurring: {AdyenEx.Checkout.V66.Recurring, :t},
      ...
      threeDS2RequestData: {AdyenEx.Checkout.V66.ThreeDs2RequestData, :t},
