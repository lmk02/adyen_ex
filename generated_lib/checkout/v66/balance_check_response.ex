defmodule AdyenEx.Checkout.V66.BalanceCheckResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          balance: AdyenEx.Checkout.V66.Amount.t(),
          fraudResult: AdyenEx.Checkout.V66.FraudResult.t() | nil,
          pspReference: String.t() | nil,
          refusalReason: String.t() | nil,
          resultCode: String.t(),
          transactionLimit: AdyenEx.Checkout.V66.Amount.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      transactionLimit: {AdyenEx.Checkout.V66.Amount, :t}
    ]
  end
end
