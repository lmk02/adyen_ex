defmodule AdyenEx.Checkout.V66.Utility do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  @spec post_apple_pay_sessions(
          body :: AdyenEx.Checkout.V66.ApplePaySessionRequest.t(),
          opts :: keyword
        ) :: {:ok, AdyenEx.Checkout.V66.ApplePaySessionResponse.t()} | :error
  def post_apple_pay_sessions(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V66.Utility, :post_apple_pay_sessions},
      url: "/applePay/sessions",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V66.ApplePaySessionRequest, :t}}],
      response: [{200, {AdyenEx.Checkout.V66.ApplePaySessionResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  """
  @spec post_origin_keys(body :: AdyenEx.Checkout.V66.UtilityRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V66.UtilityResponse.t()}
  ...
  def post_origin_keys(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V66.Utility, :post_origin_keys},
      url: "/originKeys",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V66.UtilityRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V66.UtilityResponse, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_paypal_update_order(
          body :: AdyenEx.Checkout.V66.PaypalUpdateOrderRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V66.PaypalUpdateOrderResponse.t()}
          | {:error, AdyenEx.Checkout.V66.ServiceError.t()}
  def post_paypal_update_order(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V66.Utility, :post_paypal_update_order},
      url: "/paypal/updateOrder",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V66.PaypalUpdateOrderRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V66.PaypalUpdateOrderResponse, :t}},
        {400, {AdyenEx.Checkout.V66.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V66.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V66.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V66.ServiceError, :t}},
