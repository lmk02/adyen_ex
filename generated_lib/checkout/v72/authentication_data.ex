defmodule Adyen.Checkout.V72.AuthenticationData do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          threeDSRequestData: Adyen.Checkout.V72.ThreeDSRequestData.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      threeDSRequestData: {Adyen.Checkout.V72.ThreeDSRequestData, :t}
    ]
  end
end
