defmodule AdyenEx.Checkout.V72.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          deliveryAddress: AdyenEx.Checkout.V72.Address.t() | nil,
          ...
          paymentMethod: map,
          recurring: AdyenEx.Checkout.V72.Recurring.t() | nil,
          ...
          threeDS2RequestData: AdyenEx.Checkout.V72.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      deliveryAddress: {AdyenEx.Checkout.V72.Address, :t},
      ...
      paymentMethod: :map,
      recurring: {AdyenEx.Checkout.V72.Recurring, :t},
      ...
      threeDS2RequestData: {AdyenEx.Checkout.V72.ThreeDs2RequestData, :t},
