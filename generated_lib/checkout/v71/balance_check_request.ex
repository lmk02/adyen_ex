defmodule AdyenEx.Checkout.V71.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          deliveryAddress: AdyenEx.Checkout.V71.Address.t() | nil,
          ...
          paymentMethod: map,
          recurring: AdyenEx.Checkout.V71.Recurring.t() | nil,
          ...
          threeDS2RequestData: AdyenEx.Checkout.V71.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      deliveryAddress: {AdyenEx.Checkout.V71.Address, :t},
      ...
      paymentMethod: :map,
      recurring: {AdyenEx.Checkout.V71.Recurring, :t},
      ...
      threeDS2RequestData: {AdyenEx.Checkout.V71.ThreeDs2RequestData, :t},
