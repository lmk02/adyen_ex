defmodule AdyenEx.Checkout.V71.PaymentResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          action:
            AdyenEx.Checkout.V71.CheckoutAwaitAction.t()
            | AdyenEx.Checkout.V71.CheckoutBankTransferAction.t()
            | AdyenEx.Checkout.V71.CheckoutDelegatedAuthenticationAction.t()
            | AdyenEx.Checkout.V71.CheckoutNativeRedirectAction.t()
            | AdyenEx.Checkout.V71.CheckoutQrCodeAction.t()
            | AdyenEx.Checkout.V71.CheckoutRedirectAction.t()
            | AdyenEx.Checkout.V71.CheckoutSDKAction.t()
            | AdyenEx.Checkout.V71.CheckoutThreeDs2Action.t()
            | AdyenEx.Checkout.V71.CheckoutVoucherAction.t()
            | nil,
