defmodule Adyen.Checkout.V71.Payments do
  @moduledoc """
  ...
  @spec get_sessions_session_id(sessionId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V71.SessionResultResponse.t()} | :error
  def get_sessions_session_id(sessionId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Checkout.V71.Payments, :get_sessions_session_id},
      url: "/sessions/#{sessionId}",
      method: :get,
      query: query,
      response: [{200, {Adyen.Checkout.V71.SessionResultResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  """
  @spec post_card_details(body :: Adyen.Checkout.V71.CardDetailsRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V71.CardDetailsResponse.t()} | :error
  def post_card_details(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V71.Payments, :post_card_details},
      url: "/cardDetails",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V71.CardDetailsRequest, :t}}],
      response: [{200, {Adyen.Checkout.V71.CardDetailsResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payment_methods(
          body :: Adyen.Checkout.V71.PaymentMethodsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V71.PaymentMethodsResponse.t()}
  ...
  def post_payment_methods(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V71.Payments, :post_payment_methods},
      url: "/paymentMethods",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V71.PaymentMethodsRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V71.PaymentMethodsResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_payments(body :: Adyen.Checkout.V71.PaymentRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V71.PaymentResponse.t()}
          | {:error, Adyen.Checkout.V71.ServiceError.t()}
  def post_payments(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V71.Payments, :post_payments},
      url: "/payments",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V71.PaymentRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V71.PaymentResponse, :t}},
        {400, {Adyen.Checkout.V71.ServiceError, :t}},
        {401, {Adyen.Checkout.V71.ServiceError, :t}},
        {403, {Adyen.Checkout.V71.ServiceError, :t}},
        {422, {Adyen.Checkout.V71.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_details(
          body :: Adyen.Checkout.V71.PaymentDetailsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V71.PaymentDetailsResponse.t()}
          | {:error, Adyen.Checkout.V71.ServiceError.t()}
  def post_payments_details(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V71.Payments, :post_payments_details},
      url: "/payments/details",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V71.PaymentDetailsRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V71.PaymentDetailsResponse, :t}},
        {400, {Adyen.Checkout.V71.ServiceError, :t}},
        {401, {Adyen.Checkout.V71.ServiceError, :t}},
        {403, {Adyen.Checkout.V71.ServiceError, :t}},
        {422, {Adyen.Checkout.V71.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_sessions(
          body :: Adyen.Checkout.V71.CreateCheckoutSessionRequest.t(),
          opts :: keyword
        ) :: {:ok, Adyen.Checkout.V71.CreateCheckoutSessionResponse.t()} | :error
  def post_sessions(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V71.Payments, :post_sessions},
      url: "/sessions",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V71.CreateCheckoutSessionRequest, :t}}],
      response: [{201, {Adyen.Checkout.V71.CreateCheckoutSessionResponse, :t}}],
      opts: opts
    })
  end
end
