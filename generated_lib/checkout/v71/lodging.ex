defmodule AdyenEx.Checkout.V71.Lodging do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          folio: AdyenEx.Checkout.V71.Folio.t() | nil,
          ...
          rooms: [AdyenEx.Checkout.V71.Room.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      folio: {AdyenEx.Checkout.V71.Folio, :t},
      ...
      renterName: :string,
      rooms: [{AdyenEx.Checkout.V71.Room, :t}],
