defmodule AdyenEx.Checkout.V41.DonationPaymentResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          payment: AdyenEx.Checkout.V41.PaymentResponse.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      payment: {AdyenEx.Checkout.V41.PaymentResponse, :t},
      reference: :string,
