defmodule AdyenEx.Checkout.V41.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: map,
          recurring: AdyenEx.Checkout.V41.Recurring.t() | nil,
          ...
          threeDS2RequestData: AdyenEx.Checkout.V41.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: :map,
      recurring: {AdyenEx.Checkout.V41.Recurring, :t},
      ...
      threeDS2RequestData: {AdyenEx.Checkout.V41.ThreeDs2RequestData, :t},
      totalsGroup: :string,
