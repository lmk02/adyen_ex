defmodule AdyenEx.Checkout.V41.PaymentLinkRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          deliveryAddress: AdyenEx.Checkout.V41.Address.t() | nil,
          ...
          metadata: map | nil,
          platformChargebackLogic: AdyenEx.Checkout.V41.PlatformChargebackLogic.t() | nil,
          ...
          store: String.t() | nil,
          threeDS2RequestData: AdyenEx.Checkout.V41.CheckoutSessionThreeDs2RequestData.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      deliveryAddress: {AdyenEx.Checkout.V41.Address, :t},
      description: :string,
      expiresAt: :string,
      ...
      metadata: :map,
      platformChargebackLogic: {AdyenEx.Checkout.V41.PlatformChargebackLogic, :t},
      ...
      store: :string,
      threeDS2RequestData: {AdyenEx.Checkout.V41.CheckoutSessionThreeDs2RequestData, :t}
    ]
  end
end
