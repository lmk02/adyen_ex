defmodule AdyenEx.Checkout.V68.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: map,
          recurring: AdyenEx.Checkout.V68.Recurring.t() | nil,
          ...
          threeDS2RequestData: AdyenEx.Checkout.V68.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: :map,
      recurring: {AdyenEx.Checkout.V68.Recurring, :t},
      ...
      threeDS2RequestData: {AdyenEx.Checkout.V68.ThreeDs2RequestData, :t},
