defmodule AdyenEx.Checkout.V68.Payment do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: AdyenEx.Checkout.V68.ResponsePaymentMethod.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: {AdyenEx.Checkout.V68.ResponsePaymentMethod, :t},
      pspReference: :string,
