defmodule AdyenEx.Checkout.V68.PaymentDetailsResponse do
  @moduledoc """
  Provides struct and type for a PaymentDetailsResponse
  """

  @type t :: %__MODULE__{
          action: AdyenEx.Checkout.V68.CheckoutThreeDs2Action.t() | nil,
  ...
  def __fields__(:t) do
    [
      action: {AdyenEx.Checkout.V68.CheckoutThreeDs2Action, :t},
      additionalData: :map,
