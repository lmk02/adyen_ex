defmodule Adyen.Checkout.V68.PaymentLinks do
  @moduledoc """
  ...
  @spec get_payment_links_link_id(linkId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V68.PaymentLinkResponse.t()}
  ...
  def get_payment_links_link_id(linkId, opts \\ []) do
    ...
    client.request(%{
      args: [linkId: linkId],
      call: {Adyen.Checkout.V68.PaymentLinks, :get_payment_links_link_id},
      url: "/paymentLinks/#{linkId}",
      method: :get,
      response: [
        {200, {Adyen.Checkout.V68.PaymentLinkResponse, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_payment_links_link_id(
          linkId :: String.t(),
          body :: Adyen.Checkout.V68.UpdatePaymentLinkRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V68.PaymentLinkResponse.t()}
          | {:error, Adyen.Checkout.V68.ServiceError.t()}
  def patch_payment_links_link_id(linkId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Checkout.V68.PaymentLinks, :patch_payment_links_link_id},
      url: "/paymentLinks/#{linkId}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.Checkout.V68.UpdatePaymentLinkRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V68.PaymentLinkResponse, :t}},
        {400, {Adyen.Checkout.V68.ServiceError, :t}},
        {401, {Adyen.Checkout.V68.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_payment_links(body :: Adyen.Checkout.V68.PaymentLinkRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V68.PaymentLinkResponse.t()}
          | {:error, Adyen.Checkout.V68.ServiceError.t()}
  def post_payment_links(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V68.PaymentLinks, :post_payment_links},
      url: "/paymentLinks",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V68.PaymentLinkRequest, :t}}],
      response: [
        {201, {Adyen.Checkout.V68.PaymentLinkResponse, :t}},
        {400, {Adyen.Checkout.V68.ServiceError, :t}},
        {401, {Adyen.Checkout.V68.ServiceError, :t}},
        {403, {Adyen.Checkout.V68.ServiceError, :t}},
        {422, {Adyen.Checkout.V68.ServiceError, :t}},
