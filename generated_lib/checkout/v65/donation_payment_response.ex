defmodule AdyenEx.Checkout.V65.DonationPaymentResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          payment: AdyenEx.Checkout.V65.PaymentResponse.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      payment: {AdyenEx.Checkout.V65.PaymentResponse, :t},
      reference: :string,
