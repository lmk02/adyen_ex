defmodule Adyen.Checkout.V65.Payments do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_card_details(body :: Adyen.Checkout.V65.CardDetailsRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V65.CardDetailsResponse.t()} | :error
  def post_card_details(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V65.Payments, :post_card_details},
      url: "/cardDetails",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V65.CardDetailsRequest, :t}}],
      response: [{200, {Adyen.Checkout.V65.CardDetailsResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payment_methods(
          body :: Adyen.Checkout.V65.PaymentMethodsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V65.PaymentMethodsResponse.t()}
  ...
  def post_payment_methods(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V65.Payments, :post_payment_methods},
      url: "/paymentMethods",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V65.PaymentMethodsRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V65.PaymentMethodsResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_payments(body :: Adyen.Checkout.V65.PaymentRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V65.PaymentResponse.t()}
          | {:error, Adyen.Checkout.V65.ServiceError.t()}
  def post_payments(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V65.Payments, :post_payments},
      url: "/payments",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V65.PaymentRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V65.PaymentResponse, :t}},
        {400, {Adyen.Checkout.V65.ServiceError, :t}},
        {401, {Adyen.Checkout.V65.ServiceError, :t}},
        {403, {Adyen.Checkout.V65.ServiceError, :t}},
        {422, {Adyen.Checkout.V65.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_details(
          body :: Adyen.Checkout.V65.PaymentDetailsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V65.PaymentDetailsResponse.t()}
          | {:error, Adyen.Checkout.V65.ServiceError.t()}
  def post_payments_details(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V65.Payments, :post_payments_details},
      url: "/payments/details",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V65.PaymentDetailsRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V65.PaymentDetailsResponse, :t}},
        {400, {Adyen.Checkout.V65.ServiceError, :t}},
        {401, {Adyen.Checkout.V65.ServiceError, :t}},
        {403, {Adyen.Checkout.V65.ServiceError, :t}},
        {422, {Adyen.Checkout.V65.ServiceError, :t}},
