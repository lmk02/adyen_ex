defmodule AdyenEx.Checkout.V37.DonationPaymentResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          payment: AdyenEx.Checkout.V37.PaymentResponse.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      payment: {AdyenEx.Checkout.V37.PaymentResponse, :t},
      reference: :string,
