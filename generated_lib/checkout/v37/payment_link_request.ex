defmodule AdyenEx.Checkout.V37.PaymentLinkRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          metadata: map | nil,
          platformChargebackLogic: AdyenEx.Checkout.V37.PlatformChargebackLogic.t() | nil,
          ...
          store: String.t() | nil,
          threeDS2RequestData: AdyenEx.Checkout.V37.CheckoutSessionThreeDs2RequestData.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      amount: {AdyenEx.Checkout.V37.Amount, :t},
      applicationInfo: {AdyenEx.Checkout.V37.ApplicationInfo, :t},
      billingAddress: {AdyenEx.Checkout.V37.Address, :t},
      blockedPaymentMethods: [:string],
      countryCode: :string,
      deliverAt: {:string, "date-time"},
      deliveryAddress: {AdyenEx.Checkout.V37.Address, :t},
      description: :string,
      expiresAt: :string,
      ...
      metadata: :map,
      platformChargebackLogic: {AdyenEx.Checkout.V37.PlatformChargebackLogic, :t},
      ...
      store: :string,
      threeDS2RequestData: {AdyenEx.Checkout.V37.CheckoutSessionThreeDs2RequestData, :t}
    ]
  end
end
