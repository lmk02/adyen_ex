defmodule AdyenEx.Checkout.V51.ThreeDs2RequestFields do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          deviceRenderOptions: AdyenEx.Checkout.V51.DeviceRenderOptions.t() | nil,
          mcc: String.t() | nil,
          merchantName: String.t() | nil,
          messageVersion: String.t() | nil,
          notificationURL: String.t() | nil,
          sdkAppID: String.t() | nil,
          sdkEphemPubKey: AdyenEx.Checkout.V51.SDKEphemPubKey.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      deviceRenderOptions: {AdyenEx.Checkout.V51.DeviceRenderOptions, :t},
      mcc: :string,
      merchantName: :string,
      messageVersion: :string,
      notificationURL: :string,
      sdkAppID: :string,
      sdkEphemPubKey: {AdyenEx.Checkout.V51.SDKEphemPubKey, :t},
