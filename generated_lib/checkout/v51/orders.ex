defmodule Adyen.Checkout.V51.Orders do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_orders(body :: Adyen.Checkout.V51.CreateOrderRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V51.CreateOrderResponse.t()}
  ...
  def post_orders(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V51.Orders, :post_orders},
      url: "/orders",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V51.CreateOrderRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V51.CreateOrderResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_orders_cancel(body :: Adyen.Checkout.V51.CancelOrderRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V51.CancelOrderResponse.t()}
          | {:error, Adyen.Checkout.V51.ServiceError.t()}
  def post_orders_cancel(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V51.Orders, :post_orders_cancel},
      url: "/orders/cancel",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V51.CancelOrderRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V51.CancelOrderResponse, :t}},
        {400, {Adyen.Checkout.V51.ServiceError, :t}},
        {401, {Adyen.Checkout.V51.ServiceError, :t}},
        {403, {Adyen.Checkout.V51.ServiceError, :t}},
        {422, {Adyen.Checkout.V51.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payment_methods_balance(
          body :: Adyen.Checkout.V51.BalanceCheckRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V51.BalanceCheckResponse.t()}
          | {:error, Adyen.Checkout.V51.ServiceError.t()}
  def post_payment_methods_balance(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V51.Orders, :post_payment_methods_balance},
      url: "/paymentMethods/balance",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V51.BalanceCheckRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V51.BalanceCheckResponse, :t}},
        {400, {Adyen.Checkout.V51.ServiceError, :t}},
        {401, {Adyen.Checkout.V51.ServiceError, :t}},
        {403, {Adyen.Checkout.V51.ServiceError, :t}},
        {422, {Adyen.Checkout.V51.ServiceError, :t}},
