defmodule AdyenEx.Checkout.V51.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: map,
          recurring: AdyenEx.Checkout.V51.Recurring.t() | nil,
          ...
          threeDS2RequestData: AdyenEx.Checkout.V51.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: :map,
      recurring: {AdyenEx.Checkout.V51.Recurring, :t},
      ...
      threeDS2RequestData: {AdyenEx.Checkout.V51.ThreeDs2RequestData, :t},
