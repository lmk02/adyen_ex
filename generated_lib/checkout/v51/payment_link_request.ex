defmodule AdyenEx.Checkout.V51.PaymentLinkRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          deliveryAddress: AdyenEx.Checkout.V51.Address.t() | nil,
          ...
          metadata: map | nil,
          platformChargebackLogic: AdyenEx.Checkout.V51.PlatformChargebackLogic.t() | nil,
          ...
          threeDS2RequestData: AdyenEx.Checkout.V51.CheckoutSessionThreeDs2RequestData.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      deliveryAddress: {AdyenEx.Checkout.V51.Address, :t},
      description: :string,
      expiresAt: :string,
      ...
      metadata: :map,
      platformChargebackLogic: {AdyenEx.Checkout.V51.PlatformChargebackLogic, :t},
      ...
      threeDS2RequestData: {AdyenEx.Checkout.V51.CheckoutSessionThreeDs2RequestData, :t}
    ]
  end
end
