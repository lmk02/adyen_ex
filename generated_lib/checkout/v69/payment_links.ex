defmodule AdyenEx.Checkout.V69.PaymentLinks do
  @moduledoc """
  ...
  @spec get_payment_links_link_id(linkId :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V69.PaymentLinkResponse.t()}
  ...
  def get_payment_links_link_id(linkId, opts \\ []) do
    ...
    client.request(%{
      args: [linkId: linkId],
      call: {AdyenEx.Checkout.V69.PaymentLinks, :get_payment_links_link_id},
      url: "/paymentLinks/#{linkId}",
      method: :get,
      response: [
        {200, {AdyenEx.Checkout.V69.PaymentLinkResponse, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_payment_links_link_id(
          linkId :: String.t(),
          body :: AdyenEx.Checkout.V69.UpdatePaymentLinkRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V69.PaymentLinkResponse.t()}
          | {:error, AdyenEx.Checkout.V69.ServiceError.t()}
  def patch_payment_links_link_id(linkId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.Checkout.V69.PaymentLinks, :patch_payment_links_link_id},
      url: "/paymentLinks/#{linkId}",
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.Checkout.V69.UpdatePaymentLinkRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V69.PaymentLinkResponse, :t}},
        {400, {AdyenEx.Checkout.V69.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V69.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_payment_links(body :: AdyenEx.Checkout.V69.PaymentLinkRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V69.PaymentLinkResponse.t()}
          | {:error, AdyenEx.Checkout.V69.ServiceError.t()}
  def post_payment_links(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V69.PaymentLinks, :post_payment_links},
      url: "/paymentLinks",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V69.PaymentLinkRequest, :t}}],
      response: [
        {201, {AdyenEx.Checkout.V69.PaymentLinkResponse, :t}},
        {400, {AdyenEx.Checkout.V69.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V69.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V69.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V69.ServiceError, :t}},
