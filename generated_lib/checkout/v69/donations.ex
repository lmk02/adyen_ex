defmodule Adyen.Checkout.V69.Donations do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  @spec post_donation_campaigns(
          body :: Adyen.Checkout.V69.DonationCampaignsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V69.DonationCampaignsResponse.t()}
  ...
  def post_donation_campaigns(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V69.Donations, :post_donation_campaigns},
      url: "/donationCampaigns",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V69.DonationCampaignsRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V69.DonationCampaignsResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_donations(body :: Adyen.Checkout.V69.DonationPaymentRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V69.DonationPaymentResponse.t()}
          | {:error, Adyen.Checkout.V69.ServiceError.t()}
  def post_donations(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V69.Donations, :post_donations},
      url: "/donations",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V69.DonationPaymentRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V69.DonationPaymentResponse, :t}},
        {400, {Adyen.Checkout.V69.ServiceError, :t}},
        {401, {Adyen.Checkout.V69.ServiceError, :t}},
        {403, {Adyen.Checkout.V69.ServiceError, :t}},
        {422, {Adyen.Checkout.V69.ServiceError, :t}},
