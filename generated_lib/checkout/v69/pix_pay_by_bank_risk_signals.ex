defmodule AdyenEx.Checkout.V69.PixPayByBankRiskSignals do
  @moduledoc """
  Provides struct and type for a PixPayByBankRiskSignals
  """

  @type t :: %__MODULE__{
          confidenceScore: AdyenEx.Checkout.V69.ConfidenceScore.t() | nil,
          elapsedTimeSinceBoot: integer | nil,
          isRootedDevice: boolean | nil,
          language: String.t() | nil,
          osVersion: String.t() | nil,
          screenBrightness: integer | nil,
          screenDimensions: AdyenEx.Checkout.V69.ScreenDimensions.t() | nil,
  ...
  def __fields__(:t) do
    [
      confidenceScore: {AdyenEx.Checkout.V69.ConfidenceScore, :t},
      elapsedTimeSinceBoot: {:integer, "int64"},
      isRootedDevice: :boolean,
      language: :string,
      osVersion: :string,
      screenBrightness: {:integer, "int32"},
      screenDimensions: {AdyenEx.Checkout.V69.ScreenDimensions, :t},
