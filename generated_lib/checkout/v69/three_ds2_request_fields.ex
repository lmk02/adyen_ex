defmodule AdyenEx.Checkout.V69.ThreeDs2RequestFields do
  @moduledoc """
  Provides struct and type for a ThreeDs2RequestFields
  """

  @type t :: %__MODULE__{
          acctInfo: AdyenEx.Checkout.V69.AcctInfo.t() | nil,
          ...
          deviceRenderOptions: AdyenEx.Checkout.V69.DeviceRenderOptions.t() | nil,
          ...
          sdkEphemPubKey: AdyenEx.Checkout.V69.SDKEphemPubKey.t() | nil,
          ...
          threeDSRequestorAuthenticationInfo:
            AdyenEx.Checkout.V69.ThreeDSRequestorAuthenticationInfo.t() | nil,
          threeDSRequestorChallengeInd: String.t() | nil,
          threeDSRequestorID: String.t() | nil,
          threeDSRequestorName: String.t() | nil,
          threeDSRequestorPriorAuthenticationInfo:
            AdyenEx.Checkout.V69.ThreeDSRequestorPriorAuthenticationInfo.t() | nil,
  ...
  def __fields__(:t) do
    [
      acctInfo: {AdyenEx.Checkout.V69.AcctInfo, :t},
      ...
      deviceRenderOptions: {AdyenEx.Checkout.V69.DeviceRenderOptions, :t},
      ...
      sdkAppID: :string,
      sdkEphemPubKey: {AdyenEx.Checkout.V69.SDKEphemPubKey, :t},
      ...
      threeDSRequestorAuthenticationInfo:
        {AdyenEx.Checkout.V69.ThreeDSRequestorAuthenticationInfo, :t},
      threeDSRequestorChallengeInd: {:enum, ["01", "02", "03", "04", "05", "06"]},
      threeDSRequestorID: :string,
      threeDSRequestorName: :string,
      threeDSRequestorPriorAuthenticationInfo:
        {AdyenEx.Checkout.V69.ThreeDSRequestorPriorAuthenticationInfo, :t},
