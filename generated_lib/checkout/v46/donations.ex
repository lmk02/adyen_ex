defmodule AdyenEx.Checkout.V46.Donations do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_donations(body :: AdyenEx.Checkout.V46.DonationPaymentRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V46.DonationPaymentResponse.t()}
  ...
  def post_donations(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V46.Donations, :post_donations},
      url: "/donations",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V46.DonationPaymentRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V46.DonationPaymentResponse, :t}},
