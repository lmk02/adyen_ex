defmodule Adyen.Checkout.V46.Utility do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  @spec post_apple_pay_sessions(
          body :: Adyen.Checkout.V46.ApplePaySessionRequest.t(),
          opts :: keyword
        ) :: {:ok, Adyen.Checkout.V46.ApplePaySessionResponse.t()} | :error
  def post_apple_pay_sessions(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V46.Utility, :post_apple_pay_sessions},
      url: "/applePay/sessions",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V46.ApplePaySessionRequest, :t}}],
      response: [{200, {Adyen.Checkout.V46.ApplePaySessionResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  """
  @spec post_origin_keys(body :: Adyen.Checkout.V46.UtilityRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V46.UtilityResponse.t()}
  ...
  def post_origin_keys(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V46.Utility, :post_origin_keys},
      url: "/originKeys",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V46.UtilityRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V46.UtilityResponse, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_paypal_update_order(
          body :: Adyen.Checkout.V46.PaypalUpdateOrderRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Checkout.V46.PaypalUpdateOrderResponse.t()}
          | {:error, Adyen.Checkout.V46.ServiceError.t()}
  def post_paypal_update_order(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V46.Utility, :post_paypal_update_order},
      url: "/paypal/updateOrder",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V46.PaypalUpdateOrderRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V46.PaypalUpdateOrderResponse, :t}},
        {400, {Adyen.Checkout.V46.ServiceError, :t}},
        {401, {Adyen.Checkout.V46.ServiceError, :t}},
        {403, {Adyen.Checkout.V46.ServiceError, :t}},
        {422, {Adyen.Checkout.V46.ServiceError, :t}},
