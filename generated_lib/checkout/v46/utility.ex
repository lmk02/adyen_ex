defmodule AdyenEx.Checkout.V46.Utility do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  @spec post_apple_pay_sessions(
          body :: AdyenEx.Checkout.V46.ApplePaySessionRequest.t(),
          opts :: keyword
        ) :: {:ok, AdyenEx.Checkout.V46.ApplePaySessionResponse.t()} | :error
  def post_apple_pay_sessions(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V46.Utility, :post_apple_pay_sessions},
      url: "/applePay/sessions",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V46.ApplePaySessionRequest, :t}}],
      response: [{200, {AdyenEx.Checkout.V46.ApplePaySessionResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  """
  @spec post_origin_keys(body :: AdyenEx.Checkout.V46.UtilityRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V46.UtilityResponse.t()}
  ...
  def post_origin_keys(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V46.Utility, :post_origin_keys},
      url: "/originKeys",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V46.UtilityRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V46.UtilityResponse, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_paypal_update_order(
          body :: AdyenEx.Checkout.V46.PaypalUpdateOrderRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V46.PaypalUpdateOrderResponse.t()}
          | {:error, AdyenEx.Checkout.V46.ServiceError.t()}
  def post_paypal_update_order(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V46.Utility, :post_paypal_update_order},
      url: "/paypal/updateOrder",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V46.PaypalUpdateOrderRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V46.PaypalUpdateOrderResponse, :t}},
        {400, {AdyenEx.Checkout.V46.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V46.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V46.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V46.ServiceError, :t}},
