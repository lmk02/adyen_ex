defmodule AdyenEx.Checkout.V46.DonationPaymentResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          payment: AdyenEx.Checkout.V46.PaymentResponse.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      payment: {AdyenEx.Checkout.V46.PaymentResponse, :t},
      reference: :string,
