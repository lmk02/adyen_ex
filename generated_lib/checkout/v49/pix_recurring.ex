defmodule AdyenEx.Checkout.V49.PixRecurring do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          minAmount: AdyenEx.Checkout.V49.Amount.t() | nil,
          originalPspReference: String.t() | nil,
          recurringAmount: AdyenEx.Checkout.V49.Amount.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      minAmount: {AdyenEx.Checkout.V49.Amount, :t},
      originalPspReference: :string,
      recurringAmount: {AdyenEx.Checkout.V49.Amount, :t},
