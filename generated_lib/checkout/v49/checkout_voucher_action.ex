defmodule AdyenEx.Checkout.V49.CheckoutVoucherAction do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          initialAmount: AdyenEx.Checkout.V49.Amount.t() | nil,
          ...
          surcharge: AdyenEx.Checkout.V49.Amount.t() | nil,
          totalAmount: AdyenEx.Checkout.V49.Amount.t() | nil,
          type: String.t(),
          url: String.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      entity: :string,
      expiresAt: :string,
      initialAmount: {AdyenEx.Checkout.V49.Amount, :t},
      ...
      shopperEmail: :string,
      shopperName: :string,
      surcharge: {AdyenEx.Checkout.V49.Amount, :t},
      totalAmount: {AdyenEx.Checkout.V49.Amount, :t},
      type: {:const, "voucher"},
      url: :string
    ]
  end
