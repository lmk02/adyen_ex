defmodule Adyen.Checkout.V49.Donations do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_donations(body :: Adyen.Checkout.V49.DonationPaymentRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Checkout.V49.DonationPaymentResponse.t()}
  ...
  def post_donations(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Checkout.V49.Donations, :post_donations},
      url: "/donations",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Checkout.V49.DonationPaymentRequest, :t}}],
      response: [
        {200, {Adyen.Checkout.V49.DonationPaymentResponse, :t}},
