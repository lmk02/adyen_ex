defmodule AdyenEx.Checkout.V49.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: map,
          recurring: AdyenEx.Checkout.V49.Recurring.t() | nil,
          ...
          threeDS2RequestData: AdyenEx.Checkout.V49.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: :map,
      recurring: {AdyenEx.Checkout.V49.Recurring, :t},
      ...
      threeDS2RequestData: {AdyenEx.Checkout.V49.ThreeDs2RequestData, :t},
      totalsGroup: :string,
