defmodule AdyenEx.Checkout.V64.Orders do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_orders(body :: AdyenEx.Checkout.V64.CreateOrderRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V64.CreateOrderResponse.t()}
  ...
  def post_orders(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V64.Orders, :post_orders},
      url: "/orders",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V64.CreateOrderRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V64.CreateOrderResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_orders_cancel(body :: AdyenEx.Checkout.V64.CancelOrderRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V64.CancelOrderResponse.t()}
          | {:error, AdyenEx.Checkout.V64.ServiceError.t()}
  def post_orders_cancel(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V64.Orders, :post_orders_cancel},
      url: "/orders/cancel",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V64.CancelOrderRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V64.CancelOrderResponse, :t}},
        {400, {AdyenEx.Checkout.V64.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V64.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V64.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V64.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payment_methods_balance(
          body :: AdyenEx.Checkout.V64.BalanceCheckRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V64.BalanceCheckResponse.t()}
          | {:error, AdyenEx.Checkout.V64.ServiceError.t()}
  def post_payment_methods_balance(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V64.Orders, :post_payment_methods_balance},
      url: "/paymentMethods/balance",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V64.BalanceCheckRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V64.BalanceCheckResponse, :t}},
        {400, {AdyenEx.Checkout.V64.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V64.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V64.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V64.ServiceError, :t}},
