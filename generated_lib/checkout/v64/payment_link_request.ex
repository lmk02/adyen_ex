defmodule AdyenEx.Checkout.V64.PaymentLinkRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          billingAddress: AdyenEx.Checkout.V64.Address.t() | nil,
          blockedPaymentMethods: [String.t()] | nil,
          countryCode: String.t() | nil,
          deliverAt: DateTime.t() | nil,
          deliveryAddress: AdyenEx.Checkout.V64.Address.t() | nil,
          ...
          metadata: map | nil,
          platformChargebackLogic: AdyenEx.Checkout.V64.PlatformChargebackLogic.t() | nil,
          ...
          shopperName: AdyenEx.Checkout.V64.Name.t() | nil,
          shopperReference: String.t() | nil,
          showRemovePaymentMethodButton: boolean | nil,
          splits: [AdyenEx.Checkout.V64.Split.t()] | nil,
          store: String.t() | nil,
          storePaymentMethod: boolean | nil,
          threeDS2RequestData: AdyenEx.Checkout.V64.CheckoutSessionThreeDs2RequestData.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      billingAddress: {AdyenEx.Checkout.V64.Address, :t},
      blockedPaymentMethods: [:string],
      countryCode: :string,
      deliverAt: {:string, "date-time"},
      deliveryAddress: {AdyenEx.Checkout.V64.Address, :t},
      description: :string,
      expiresAt: :string,
      ...
      metadata: :map,
      platformChargebackLogic: {AdyenEx.Checkout.V64.PlatformChargebackLogic, :t},
      ...
      shopperName: {AdyenEx.Checkout.V64.Name, :t},
      shopperReference: :string,
      showRemovePaymentMethodButton: :boolean,
      splits: [{AdyenEx.Checkout.V64.Split, :t}],
      store: :string,
      storePaymentMethod: :boolean,
      threeDS2RequestData: {AdyenEx.Checkout.V64.CheckoutSessionThreeDs2RequestData, :t}
    ]
  end
end
