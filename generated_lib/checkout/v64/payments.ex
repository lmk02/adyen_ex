defmodule AdyenEx.Checkout.V64.Payments do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_card_details(body :: AdyenEx.Checkout.V64.CardDetailsRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V64.CardDetailsResponse.t()} | :error
  def post_card_details(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V64.Payments, :post_card_details},
      url: "/cardDetails",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V64.CardDetailsRequest, :t}}],
      response: [{200, {AdyenEx.Checkout.V64.CardDetailsResponse, :t}}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payment_methods(
          body :: AdyenEx.Checkout.V64.PaymentMethodsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V64.PaymentMethodsResponse.t()}
  ...
  def post_payment_methods(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V64.Payments, :post_payment_methods},
      url: "/paymentMethods",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V64.PaymentMethodsRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V64.PaymentMethodsResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_payments(body :: AdyenEx.Checkout.V64.PaymentRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Checkout.V64.PaymentResponse.t()}
          | {:error, AdyenEx.Checkout.V64.ServiceError.t()}
  def post_payments(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V64.Payments, :post_payments},
      url: "/payments",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V64.PaymentRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V64.PaymentResponse, :t}},
        {400, {AdyenEx.Checkout.V64.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V64.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V64.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V64.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payments_details(
          body :: AdyenEx.Checkout.V64.PaymentDetailsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Checkout.V64.PaymentDetailsResponse.t()}
          | {:error, AdyenEx.Checkout.V64.ServiceError.t()}
  def post_payments_details(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Checkout.V64.Payments, :post_payments_details},
      url: "/payments/details",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Checkout.V64.PaymentDetailsRequest, :t}}],
      response: [
        {200, {AdyenEx.Checkout.V64.PaymentDetailsResponse, :t}},
        {400, {AdyenEx.Checkout.V64.ServiceError, :t}},
        {401, {AdyenEx.Checkout.V64.ServiceError, :t}},
        {403, {AdyenEx.Checkout.V64.ServiceError, :t}},
        {422, {AdyenEx.Checkout.V64.ServiceError, :t}},
