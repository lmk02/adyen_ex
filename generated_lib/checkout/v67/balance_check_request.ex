defmodule AdyenEx.Checkout.V67.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: map,
          recurring: AdyenEx.Checkout.V67.Recurring.t() | nil,
          ...
          threeDS2RequestData: AdyenEx.Checkout.V67.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: :map,
      recurring: {AdyenEx.Checkout.V67.Recurring, :t},
      ...
      threeDS2RequestData: {AdyenEx.Checkout.V67.ThreeDs2RequestData, :t},
