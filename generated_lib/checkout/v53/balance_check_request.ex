defmodule AdyenEx.Checkout.V53.BalanceCheckRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          paymentMethod: map,
          recurring: AdyenEx.Checkout.V53.Recurring.t() | nil,
          ...
          threeDS2RequestData: AdyenEx.Checkout.V53.ThreeDs2RequestData.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      paymentMethod: :map,
      recurring: {AdyenEx.Checkout.V53.Recurring, :t},
      ...
      threeDS2RequestData: {AdyenEx.Checkout.V53.ThreeDs2RequestData, :t},
