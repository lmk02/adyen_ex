defmodule AdyenEx.Recurring.V40.RecurringDetailsResult do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          details: [AdyenEx.Recurring.V40.RecurringDetailWrapper.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      details: [{AdyenEx.Recurring.V40.RecurringDetailWrapper, :t}],
