defmodule AdyenEx.Recurring.V68.Permit do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          restriction: AdyenEx.Recurring.V68.PermitRestriction.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      restriction: {AdyenEx.Recurring.V68.PermitRestriction, :t},
      resultKey: :string,
