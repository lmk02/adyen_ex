defmodule AdyenEx.Recurring.V67.Permit do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          restriction: AdyenEx.Recurring.V67.PermitRestriction.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      restriction: {AdyenEx.Recurring.V67.PermitRestriction, :t},
      resultKey: :string,
