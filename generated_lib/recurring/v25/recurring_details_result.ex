defmodule AdyenEx.Recurring.V25.RecurringDetailsResult do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          details: [AdyenEx.Recurring.V25.RecurringDetailWrapper.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      details: [{AdyenEx.Recurring.V25.RecurringDetailWrapper, :t}],
