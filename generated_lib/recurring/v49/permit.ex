defmodule AdyenEx.Recurring.V49.Permit do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          restriction: AdyenEx.Recurring.V49.PermitRestriction.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      restriction: {AdyenEx.Recurring.V49.PermitRestriction, :t},
      resultKey: :string,
