defmodule AdyenEx.BinLookup.V40.General do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  @spec post_get3_ds_availability(
          body :: AdyenEx.BinLookup.V40.ThreeDSAvailabilityRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.BinLookup.V40.ThreeDSAvailabilityResponse.t()}
          | {:error, AdyenEx.BinLookup.V40.ServiceError.t()}
  def post_get3_ds_availability(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {AdyenEx.BinLookup.V40.General, :post_get3_ds_availability},
      url: "/get3dsAvailability",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.BinLookup.V40.ThreeDSAvailabilityRequest, :t}}],
      response: [
        {200, {AdyenEx.BinLookup.V40.ThreeDSAvailabilityResponse, :t}},
        {400, {AdyenEx.BinLookup.V40.ServiceError, :t}},
        {401, {AdyenEx.BinLookup.V40.ServiceError, :t}},
        {403, {AdyenEx.BinLookup.V40.ServiceError, :t}},
        {422, {AdyenEx.BinLookup.V40.ServiceError, :t}},
        {500, {AdyenEx.BinLookup.V40.ServiceError, :t}}
      ],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  ...
  @spec post_get_cost_estimate(
          body :: AdyenEx.BinLookup.V40.CostEstimateRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.BinLookup.V40.CostEstimateResponse.t()}
          | {:error, AdyenEx.BinLookup.V40.ServiceError.t()}
  def post_get_cost_estimate(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.BinLookup.V40.General, :post_get_cost_estimate},
      url: "/getCostEstimate",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.BinLookup.V40.CostEstimateRequest, :t}}],
      response: [
        {200, {AdyenEx.BinLookup.V40.CostEstimateResponse, :t}},
        {400, {AdyenEx.BinLookup.V40.ServiceError, :t}},
        {401, {AdyenEx.BinLookup.V40.ServiceError, :t}},
        {403, {AdyenEx.BinLookup.V40.ServiceError, :t}},
        {422, {AdyenEx.BinLookup.V40.ServiceError, :t}},
