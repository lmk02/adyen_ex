defmodule AdyenEx.Payment.V49.VoidPendingRefundRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          modificationAmount: AdyenEx.Payment.V49.Amount.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      modificationAmount: {AdyenEx.Payment.V49.Amount, :t},
