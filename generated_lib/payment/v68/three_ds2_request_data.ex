defmodule AdyenEx.Payment.V68.ThreeDs2RequestData do
  @moduledoc """
  Provides struct and type for a ThreeDs2RequestData
  """

  @type t :: %__MODULE__{
          acctInfo: AdyenEx.Payment.V68.AcctInfo.t() | nil,
          ...
          deviceRenderOptions: AdyenEx.Payment.V68.DeviceRenderOptions.t() | nil,
          homePhone: AdyenEx.Payment.V68.Phone.t() | nil,
          mcc: String.t() | nil,
          merchantName: String.t() | nil,
          messageVersion: String.t() | nil,
          mobilePhone: AdyenEx.Payment.V68.Phone.t() | nil,
          ...
          sdkEphemPubKey: AdyenEx.Payment.V68.SDKEphemPubKey.t() | nil,
  ...
  def __fields__(:t) do
    [
      acctInfo: {AdyenEx.Payment.V68.AcctInfo, :t},
      ...
      deviceRenderOptions: {AdyenEx.Payment.V68.DeviceRenderOptions, :t},
      homePhone: {AdyenEx.Payment.V68.Phone, :t},
      mcc: :string,
      merchantName: :string,
      messageVersion: :string,
      mobilePhone: {AdyenEx.Payment.V68.Phone, :t},
      ...
      sdkAppID: :string,
      sdkEncData: :string,
      sdkEphemPubKey: {AdyenEx.Payment.V68.SDKEphemPubKey, :t},
      ...
      threeDSRequestorAuthenticationInfo:
        {AdyenEx.Payment.V68.ThreeDSRequestorAuthenticationInfo, :t},
      threeDSRequestorChallengeInd: {:enum, ["01", "02", "03", "04", "05", "06"]},
      threeDSRequestorID: :string,
      threeDSRequestorName: :string,
      threeDSRequestorPriorAuthenticationInfo:
        {AdyenEx.Payment.V68.ThreeDSRequestorPriorAuthenticationInfo, :t},
      ...
      workPhone: {AdyenEx.Payment.V68.Phone, :t}
    ]
  end
end
