defmodule AdyenEx.Payment.V51.ThreeDs2RequestData do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          deviceRenderOptions: AdyenEx.Payment.V51.DeviceRenderOptions.t() | nil,
          mcc: String.t() | nil,
          ...
          sdkEphemPubKey: AdyenEx.Payment.V51.SDKEphemPubKey.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      deviceRenderOptions: {AdyenEx.Payment.V51.DeviceRenderOptions, :t},
      mcc: :string,
      merchantName: :string,
      ...
      sdkAppID: :string,
      sdkEncData: :string,
      sdkEphemPubKey: {AdyenEx.Payment.V51.SDKEphemPubKey, :t},
