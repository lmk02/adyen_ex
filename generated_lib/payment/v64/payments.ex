defmodule AdyenEx.Payment.V64.Payments do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_authorise(body :: AdyenEx.Payment.V64.PaymentRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payment.V64.PaymentResult.t()}
  ...
  def post_authorise(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payment.V64.Payments, :post_authorise},
      url: "/authorise",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payment.V64.PaymentRequest, :t}}],
      response: [
        {200, {AdyenEx.Payment.V64.PaymentResult, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_authorise3_d(body :: AdyenEx.Payment.V64.PaymentRequest3D.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payment.V64.PaymentResult.t()}
          | {:error, AdyenEx.Payment.V64.ServiceError.t()}
  def post_authorise3_d(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payment.V64.Payments, :post_authorise3_d},
      url: "/authorise3d",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payment.V64.PaymentRequest3D, :t}}],
      response: [
        {200, {AdyenEx.Payment.V64.PaymentResult, :t}},
        {400, {AdyenEx.Payment.V64.ServiceError, :t}},
        {401, {AdyenEx.Payment.V64.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_authorise3_ds2(body :: AdyenEx.Payment.V64.PaymentRequest3Ds2.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payment.V64.PaymentResult.t()}
          | {:error, AdyenEx.Payment.V64.ServiceError.t()}
  def post_authorise3_ds2(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payment.V64.Payments, :post_authorise3_ds2},
      url: "/authorise3ds2",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payment.V64.PaymentRequest3Ds2, :t}}],
      response: [
        {200, {AdyenEx.Payment.V64.PaymentResult, :t}},
        {400, {AdyenEx.Payment.V64.ServiceError, :t}},
        {401, {AdyenEx.Payment.V64.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_get_authentication_result(
          body :: AdyenEx.Payment.V64.AuthenticationResultRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Payment.V64.AuthenticationResultResponse.t()}
          | {:error, AdyenEx.Payment.V64.ServiceError.t()}
  def post_get_authentication_result(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payment.V64.Payments, :post_get_authentication_result},
      url: "/getAuthenticationResult",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payment.V64.AuthenticationResultRequest, :t}}],
      response: [
        {200, {AdyenEx.Payment.V64.AuthenticationResultResponse, :t}},
        {400, {AdyenEx.Payment.V64.ServiceError, :t}},
        {401, {AdyenEx.Payment.V64.ServiceError, :t}},
        {403, {AdyenEx.Payment.V64.ServiceError, :t}},
        {422, {AdyenEx.Payment.V64.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_retrieve3_ds2_result(
          body :: AdyenEx.Payment.V64.ThreeDs2ResultRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Payment.V64.ThreeDs2ResultResponse.t()}
          | {:error, AdyenEx.Payment.V64.ServiceError.t()}
  def post_retrieve3_ds2_result(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payment.V64.Payments, :post_retrieve3_ds2_result},
      url: "/retrieve3ds2Result",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payment.V64.ThreeDs2ResultRequest, :t}}],
      response: [
        {200, {AdyenEx.Payment.V64.ThreeDs2ResultResponse, :t}},
        {400, {AdyenEx.Payment.V64.ServiceError, :t}},
        {401, {AdyenEx.Payment.V64.ServiceError, :t}},
        {403, {AdyenEx.Payment.V64.ServiceError, :t}},
        {422, {AdyenEx.Payment.V64.ServiceError, :t}},
