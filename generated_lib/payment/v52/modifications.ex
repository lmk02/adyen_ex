defmodule AdyenEx.Payment.V52.Modifications do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  @spec post_adjust_authorisation(
          body :: AdyenEx.Payment.V52.AdjustAuthorisationRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Payment.V52.ModificationResult.t()}
          | {:error, AdyenEx.Payment.V52.ServiceError.t()}
  def post_adjust_authorisation(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payment.V52.Modifications, :post_adjust_authorisation},
      url: "/adjustAuthorisation",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payment.V52.AdjustAuthorisationRequest, :t}}],
      response: [
        {200, {AdyenEx.Payment.V52.ModificationResult, :t}},
        {400, {AdyenEx.Payment.V52.ServiceError, :t}},
        {401, {AdyenEx.Payment.V52.ServiceError, :t}},
        {403, {AdyenEx.Payment.V52.ServiceError, :t}},
        {422, {AdyenEx.Payment.V52.ServiceError, :t}},
        {500, {AdyenEx.Payment.V52.ServiceError, :t}}
      ],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  """
  @spec post_cancel(body :: AdyenEx.Payment.V52.CancelRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payment.V52.ModificationResult.t()}
          | {:error, AdyenEx.Payment.V52.ServiceError.t()}
  def post_cancel(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payment.V52.Modifications, :post_cancel},
      url: "/cancel",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payment.V52.CancelRequest, :t}}],
      response: [
        {200, {AdyenEx.Payment.V52.ModificationResult, :t}},
        {400, {AdyenEx.Payment.V52.ServiceError, :t}},
        {401, {AdyenEx.Payment.V52.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_cancel_or_refund(
          body :: AdyenEx.Payment.V52.CancelOrRefundRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Payment.V52.ModificationResult.t()}
          | {:error, AdyenEx.Payment.V52.ServiceError.t()}
  def post_cancel_or_refund(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payment.V52.Modifications, :post_cancel_or_refund},
      url: "/cancelOrRefund",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payment.V52.CancelOrRefundRequest, :t}}],
      response: [
        {200, {AdyenEx.Payment.V52.ModificationResult, :t}},
        {400, {AdyenEx.Payment.V52.ServiceError, :t}},
        {401, {AdyenEx.Payment.V52.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_capture(body :: AdyenEx.Payment.V52.CaptureRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payment.V52.ModificationResult.t()}
          | {:error, AdyenEx.Payment.V52.ServiceError.t()}
  def post_capture(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payment.V52.Modifications, :post_capture},
      url: "/capture",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payment.V52.CaptureRequest, :t}}],
      response: [
        {200, {AdyenEx.Payment.V52.ModificationResult, :t}},
        {400, {AdyenEx.Payment.V52.ServiceError, :t}},
        {401, {AdyenEx.Payment.V52.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_donate(body :: AdyenEx.Payment.V52.DonationRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payment.V52.ModificationResult.t()}
          | {:error, AdyenEx.Payment.V52.ServiceError.t()}
  def post_donate(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payment.V52.Modifications, :post_donate},
      url: "/donate",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payment.V52.DonationRequest, :t}}],
      response: [
        {200, {AdyenEx.Payment.V52.ModificationResult, :t}},
        {400, {AdyenEx.Payment.V52.ServiceError, :t}},
        {401, {AdyenEx.Payment.V52.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_refund(body :: AdyenEx.Payment.V52.RefundRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payment.V52.ModificationResult.t()}
          | {:error, AdyenEx.Payment.V52.ServiceError.t()}
  def post_refund(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payment.V52.Modifications, :post_refund},
      url: "/refund",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payment.V52.RefundRequest, :t}}],
      response: [
        {200, {AdyenEx.Payment.V52.ModificationResult, :t}},
        {400, {AdyenEx.Payment.V52.ServiceError, :t}},
        {401, {AdyenEx.Payment.V52.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_technical_cancel(
          body :: AdyenEx.Payment.V52.TechnicalCancelRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Payment.V52.ModificationResult.t()}
          | {:error, AdyenEx.Payment.V52.ServiceError.t()}
  def post_technical_cancel(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payment.V52.Modifications, :post_technical_cancel},
      url: "/technicalCancel",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payment.V52.TechnicalCancelRequest, :t}}],
      response: [
        {200, {AdyenEx.Payment.V52.ModificationResult, :t}},
        {400, {AdyenEx.Payment.V52.ServiceError, :t}},
        {401, {AdyenEx.Payment.V52.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_void_pending_refund(
          body :: AdyenEx.Payment.V52.VoidPendingRefundRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Payment.V52.ModificationResult.t()}
          | {:error, AdyenEx.Payment.V52.ServiceError.t()}
  def post_void_pending_refund(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payment.V52.Modifications, :post_void_pending_refund},
      url: "/voidPendingRefund",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payment.V52.VoidPendingRefundRequest, :t}}],
      response: [
        {200, {AdyenEx.Payment.V52.ModificationResult, :t}},
        {400, {AdyenEx.Payment.V52.ServiceError, :t}},
        {401, {AdyenEx.Payment.V52.ServiceError, :t}},
