defmodule AdyenEx.Hop.V1.HostedOnboardingPage do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  @spec post_get_onboarding_url(
          body :: AdyenEx.Hop.V1.GetOnboardingUrlRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Hop.V1.GetOnboardingUrlResponse.t()}
          | {:error, AdyenEx.Hop.V1.ServiceError.t()}
  def post_get_onboarding_url(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {AdyenEx.Hop.V1.HostedOnboardingPage, :post_get_onboarding_url},
      url: "/getOnboardingUrl",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Hop.V1.GetOnboardingUrlRequest, :t}}],
      response: [
        {200, {AdyenEx.Hop.V1.GetOnboardingUrlResponse, :t}},
