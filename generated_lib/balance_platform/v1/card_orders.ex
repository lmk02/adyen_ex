defmodule AdyenEx.BalancePlatform.V1.CardOrders do
  @moduledoc """
  ...
  @spec get_cardorders(opts :: keyword) ::
          {:ok, AdyenEx.BalancePlatform.V1.PaginatedGetCardOrderResponse.t()}
  ...
  def get_cardorders(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {AdyenEx.BalancePlatform.V1.CardOrders, :get_cardorders},
      url: "/cardorders",
      method: :get,
      query: query,
      response: [
        {200, {AdyenEx.BalancePlatform.V1.PaginatedGetCardOrderResponse, :t}},
  ...
  @spec get_cardorders_id_items(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.BalancePlatform.V1.PaginatedGetCardOrderItemResponse.t()}
          | {:error, AdyenEx.BalancePlatform.V1.RestServiceError.t()}
  def get_cardorders_id_items(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.BalancePlatform.V1.CardOrders, :get_cardorders_id_items},
      url: "/cardorders/#{id}/items",
      method: :get,
      query: query,
      response: [
        {200, {AdyenEx.BalancePlatform.V1.PaginatedGetCardOrderItemResponse, :t}},
        {401, {AdyenEx.BalancePlatform.V1.RestServiceError, :t}},
        {403, {AdyenEx.BalancePlatform.V1.RestServiceError, :t}},
        {422, {AdyenEx.BalancePlatform.V1.RestServiceError, :t}},
        {500, {AdyenEx.BalancePlatform.V1.RestServiceError, :t}}
