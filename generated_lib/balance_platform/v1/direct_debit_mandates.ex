defmodule AdyenEx.BalancePlatform.V1.DirectDebitMandates do
  @moduledoc """
  ...
  @spec get_mandates(opts :: keyword) ::
          {:ok, AdyenEx.BalancePlatform.V1.ListMandatesResponse.t()}
          | {:error, AdyenEx.BalancePlatform.V1.DefaultErrorResponseEntity.t()}
  def get_mandates(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {AdyenEx.BalancePlatform.V1.DirectDebitMandates, :get_mandates},
      url: "/mandates",
      method: :get,
      query: query,
      response: [
        {200, {AdyenEx.BalancePlatform.V1.ListMandatesResponse, :t}},
        {401, {AdyenEx.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {422, {AdyenEx.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {500, {AdyenEx.BalancePlatform.V1.DefaultErrorResponseEntity, :t}}
      ],
      opts: opts
    })
  end
  ...
  @spec get_mandates_mandate_id(mandateId :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.BalancePlatform.V1.Mandate.t()}
          | {:error, AdyenEx.BalancePlatform.V1.DefaultErrorResponseEntity.t()}
  def get_mandates_mandate_id(mandateId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.BalancePlatform.V1.DirectDebitMandates, :get_mandates_mandate_id},
      url: "/mandates/#{mandateId}",
      method: :get,
      response: [
        {200, {AdyenEx.BalancePlatform.V1.Mandate, :t}},
        {401, {AdyenEx.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {404, {AdyenEx.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {422, {AdyenEx.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {500, {AdyenEx.BalancePlatform.V1.DefaultErrorResponseEntity, :t}}
      ],
      opts: opts
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_mandates_mandate_id(
          mandateId :: String.t(),
          body :: AdyenEx.BalancePlatform.V1.MandateUpdate.t(),
          opts :: keyword
        ) :: :ok | {:error, AdyenEx.BalancePlatform.V1.DefaultErrorResponseEntity.t()}
  def patch_mandates_mandate_id(mandateId, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [mandateId: mandateId, body: body],
      call: {AdyenEx.BalancePlatform.V1.DirectDebitMandates, :patch_mandates_mandate_id},
      url: "/mandates/#{mandateId}",
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.BalancePlatform.V1.MandateUpdate, :t}}],
      response: [
        {202, :null},
        {401, {AdyenEx.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.BalancePlatform.V1.DefaultErrorResponseEntity, :t}},
  ...
  def post_mandates_mandate_id_cancel(mandateId, opts \\ []) do
    ...
    client.request(%{
      args: [mandateId: mandateId],
      call: {AdyenEx.BalancePlatform.V1.DirectDebitMandates, :post_mandates_mandate_id_cancel},
