defmodule AdyenEx.BalancePlatform.V1.SearchRegisteredDevicesResponse do
  @moduledoc """
  Provides struct and type for a SearchRegisteredDevicesResponse
  """

  @type t :: %__MODULE__{
          data: [AdyenEx.BalancePlatform.V1.Device.t()] | nil,
          itemsTotal: integer | nil,
          link: AdyenEx.BalancePlatform.V1.Link.t() | nil,
  ...
  def __fields__(:t) do
    [
      data: [{AdyenEx.BalancePlatform.V1.Device, :t}],
