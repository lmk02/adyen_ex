defmodule AdyenEx.BalancePlatform.V1.AccountHolders do
  @moduledoc """
  ...
  def get_account_holders_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.BalancePlatform.V1.AccountHolders, :get_account_holders_id},
  ...
  @spec get_account_holders_id_balance_accounts(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.BalancePlatform.V1.PaginatedBalanceAccountsResponse.t()}
          | {:error, AdyenEx.BalancePlatform.V1.RestServiceError.t()}
  def get_account_holders_id_balance_accounts(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.BalancePlatform.V1.AccountHolders, :get_account_holders_id_balance_accounts},
      url: "/accountHolders/#{id}/balanceAccounts",
      method: :get,
      query: query,
      response: [
        {200, {AdyenEx.BalancePlatform.V1.PaginatedBalanceAccountsResponse, :t}},
        {400, {AdyenEx.BalancePlatform.V1.RestServiceError, :t}},
        {401, {AdyenEx.BalancePlatform.V1.RestServiceError, :t}},
        {403, {AdyenEx.BalancePlatform.V1.RestServiceError, :t}},
        {422, {AdyenEx.BalancePlatform.V1.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  def patch_account_holders_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.BalancePlatform.V1.AccountHolders, :patch_account_holders_id},
      url: "/accountHolders/#{id}",
      body: body,
      method: :patch,
  ...
  **Content Types**: `application/json`
  ...
  @spec post_account_holders(
          body :: AdyenEx.BalancePlatform.V1.AccountHolderInfo.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.BalancePlatform.V1.AccountHolder.t()}
          | {:error, AdyenEx.BalancePlatform.V1.RestServiceError.t()}
  def post_account_holders(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.BalancePlatform.V1.AccountHolders, :post_account_holders},
      url: "/accountHolders",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.BalancePlatform.V1.AccountHolderInfo, :t}}],
      response: [
        {200, {AdyenEx.BalancePlatform.V1.AccountHolder, :t}},
        {400, {AdyenEx.BalancePlatform.V1.RestServiceError, :t}},
        {401, {AdyenEx.BalancePlatform.V1.RestServiceError, :t}},
