defmodule Adyen.BalancePlatform.V2.TransactionRules do
  @moduledoc """
  ...
  @spec delete_transaction_rules_transaction_rule_id(
          ...
          {:ok, Adyen.BalancePlatform.V2.TransactionRule.t()}
  ...
  def delete_transaction_rules_transaction_rule_id(transactionRuleId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.BalancePlatform.V2.TransactionRules, :delete_transaction_rules_transaction_rule_id},
      url: "/transactionRules/#{transactionRuleId}",
      method: :delete,
      response: [
        {200, {Adyen.BalancePlatform.V2.TransactionRule, :t}},
  ...
  @spec get_transaction_rules_transaction_rule_id(
          ...
          {:ok, Adyen.BalancePlatform.V2.TransactionRuleResponse.t()}
          | {:error, Adyen.BalancePlatform.V2.RestServiceError.t()}
  def get_transaction_rules_transaction_rule_id(transactionRuleId, opts \\ []) do
    ...
    client.request(%{
      args: [transactionRuleId: transactionRuleId],
      call:
        {Adyen.BalancePlatform.V2.TransactionRules, :get_transaction_rules_transaction_rule_id},
      url: "/transactionRules/#{transactionRuleId}",
      method: :get,
      response: [
        {200, {Adyen.BalancePlatform.V2.TransactionRuleResponse, :t}},
        {400, {Adyen.BalancePlatform.V2.RestServiceError, :t}},
        {401, {Adyen.BalancePlatform.V2.RestServiceError, :t}},
        {403, {Adyen.BalancePlatform.V2.RestServiceError, :t}},
        {422, {Adyen.BalancePlatform.V2.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_transaction_rules_transaction_rule_id(
          transactionRuleId :: String.t(),
          body :: Adyen.BalancePlatform.V2.TransactionRuleInfo.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.BalancePlatform.V2.TransactionRule.t()}
          | {:error, Adyen.BalancePlatform.V2.RestServiceError.t()}
  def patch_transaction_rules_transaction_rule_id(transactionRuleId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.BalancePlatform.V2.TransactionRules, :patch_transaction_rules_transaction_rule_id},
      url: "/transactionRules/#{transactionRuleId}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.BalancePlatform.V2.TransactionRuleInfo, :t}}],
      response: [
        {200, {Adyen.BalancePlatform.V2.TransactionRule, :t}},
        {400, {Adyen.BalancePlatform.V2.RestServiceError, :t}},
        {401, {Adyen.BalancePlatform.V2.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  def post_transaction_rules(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.BalancePlatform.V2.TransactionRules, :post_transaction_rules},
