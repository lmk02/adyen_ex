defmodule AdyenEx.BalancePlatform.V2.TransferLimit do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          scaInformation: AdyenEx.BalancePlatform.V2.ScaInformation.t() | nil,
          scope: String.t(),
          startsAt: DateTime.t(),
  ...
  def __fields__(:t) do
    [
      ...
      reference: :string,
      scaInformation: {AdyenEx.BalancePlatform.V2.ScaInformation, :t},
