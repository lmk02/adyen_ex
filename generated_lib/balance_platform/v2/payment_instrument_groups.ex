defmodule AdyenEx.BalancePlatform.V2.PaymentInstrumentGroups do
  @moduledoc """
  ...
  @spec get_payment_instrument_groups_id(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.BalancePlatform.V2.PaymentInstrumentGroup.t()}
  ...
  def get_payment_instrument_groups_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call:
        {AdyenEx.BalancePlatform.V2.PaymentInstrumentGroups, :get_payment_instrument_groups_id},
      url: "/paymentInstrumentGroups/#{id}",
      method: :get,
      response: [
        {200, {AdyenEx.BalancePlatform.V2.PaymentInstrumentGroup, :t}},
  ...
  def get_payment_instrument_groups_id_transaction_rules(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call:
        {AdyenEx.BalancePlatform.V2.PaymentInstrumentGroups,
  ...
  **Content Types**: `application/json`
  ...
  @spec post_payment_instrument_groups(
          body :: AdyenEx.BalancePlatform.V2.PaymentInstrumentGroupInfo.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.BalancePlatform.V2.PaymentInstrumentGroup.t()}
          | {:error, AdyenEx.BalancePlatform.V2.RestServiceError.t()}
  def post_payment_instrument_groups(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.BalancePlatform.V2.PaymentInstrumentGroups, :post_payment_instrument_groups},
      url: "/paymentInstrumentGroups",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.BalancePlatform.V2.PaymentInstrumentGroupInfo, :t}}],
      response: [
        {200, {AdyenEx.BalancePlatform.V2.PaymentInstrumentGroup, :t}},
        {400, {AdyenEx.BalancePlatform.V2.RestServiceError, :t}},
        {401, {AdyenEx.BalancePlatform.V2.RestServiceError, :t}},
