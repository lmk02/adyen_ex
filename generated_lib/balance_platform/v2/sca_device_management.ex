defmodule AdyenEx.BalancePlatform.V2.SCADeviceManagement do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_sca_devices_device_id(
          deviceId :: String.t(),
          body :: AdyenEx.BalancePlatform.V2.FinishScaDeviceRegistrationRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.BalancePlatform.V2.FinishScaDeviceRegistrationResponse.t()}
  ...
  def patch_sca_devices_device_id(deviceId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.BalancePlatform.V2.SCADeviceManagement, :patch_sca_devices_device_id},
      url: "/scaDevices/#{deviceId}",
      body: body,
      method: :patch,
      request: [
        {"application/json", {AdyenEx.BalancePlatform.V2.FinishScaDeviceRegistrationRequest, :t}}
      ],
      response: [
        {200, {AdyenEx.BalancePlatform.V2.FinishScaDeviceRegistrationResponse, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_sca_devices(
          body :: AdyenEx.BalancePlatform.V2.BeginScaDeviceRegistrationRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.BalancePlatform.V2.BeginScaDeviceRegistrationResponse.t()}
          | {:error, AdyenEx.BalancePlatform.V2.DefaultErrorResponseEntity.t()}
  def post_sca_devices(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.BalancePlatform.V2.SCADeviceManagement, :post_sca_devices},
      url: "/scaDevices",
      body: body,
      method: :post,
      request: [
        {"application/json", {AdyenEx.BalancePlatform.V2.BeginScaDeviceRegistrationRequest, :t}}
      ],
      response: [
        {201, {AdyenEx.BalancePlatform.V2.BeginScaDeviceRegistrationResponse, :t}},
        {400, {AdyenEx.BalancePlatform.V2.DefaultErrorResponseEntity, :t}},
        {401, {AdyenEx.BalancePlatform.V2.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.BalancePlatform.V2.DefaultErrorResponseEntity, :t}},
        {422, {AdyenEx.BalancePlatform.V2.DefaultErrorResponseEntity, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_sca_devices_device_id_sca_associations(
          deviceId :: String.t(),
          body :: AdyenEx.BalancePlatform.V2.SubmitScaAssociationRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.BalancePlatform.V2.SubmitScaAssociationResponse.t()}
          | {:error, AdyenEx.BalancePlatform.V2.DefaultErrorResponseEntity.t()}
  def post_sca_devices_device_id_sca_associations(deviceId, body, opts \\ []) do
    ...
    client.request(%{
      args: [deviceId: deviceId, body: body],
      call:
        {AdyenEx.BalancePlatform.V2.SCADeviceManagement,
         :post_sca_devices_device_id_sca_associations},
      url: "/scaDevices/#{deviceId}/scaAssociations",
      body: body,
      method: :post,
      request: [
        {"application/json", {AdyenEx.BalancePlatform.V2.SubmitScaAssociationRequest, :t}}
      ],
      response: [
        {201, {AdyenEx.BalancePlatform.V2.SubmitScaAssociationResponse, :t}},
        {400, {AdyenEx.BalancePlatform.V2.DefaultErrorResponseEntity, :t}},
        {401, {AdyenEx.BalancePlatform.V2.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.BalancePlatform.V2.DefaultErrorResponseEntity, :t}},
        {404, {AdyenEx.BalancePlatform.V2.DefaultErrorResponseEntity, :t}},
