defmodule AdyenEx.NotificationConfiguration.V3.GetNotificationConfigurationListResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          configurations:
            [AdyenEx.NotificationConfiguration.V3.NotificationConfigurationDetailsWrapper.t()]
            | nil,
