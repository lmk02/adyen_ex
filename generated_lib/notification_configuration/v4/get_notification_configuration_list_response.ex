defmodule AdyenEx.NotificationConfiguration.V4.GetNotificationConfigurationListResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          configurations:
            [AdyenEx.NotificationConfiguration.V4.NotificationConfigurationDetailsWrapper.t()]
            | nil,
