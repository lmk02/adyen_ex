defmodule AdyenEx.NotificationConfiguration.V1.NotificationConfigurationDetails do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          eventConfigs:
            [AdyenEx.NotificationConfiguration.V1.NotificationEventConfigurationWrapper.t()] | nil,
  ...
  def __fields__(:t) do
    [
      ...
      description: :string,
      eventConfigs: [
        {AdyenEx.NotificationConfiguration.V1.NotificationEventConfigurationWrapper, :t}
      ],
