defmodule AdyenEx.NotificationConfiguration.V2.GetNotificationConfigurationListResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          configurations:
            [AdyenEx.NotificationConfiguration.V2.NotificationConfigurationDetailsWrapper.t()]
            | nil,
