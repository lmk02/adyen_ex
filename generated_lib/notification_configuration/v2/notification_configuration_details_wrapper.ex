defmodule AdyenEx.NotificationConfiguration.V2.NotificationConfigurationDetailsWrapper do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          NotificationConfigurationDetails:
            AdyenEx.NotificationConfiguration.V2.NotificationConfigurationDetails.t() | nil
        }
