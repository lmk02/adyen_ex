defmodule AdyenEx.Transfer.V3.Transfers do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_transfers(body :: AdyenEx.Transfer.V3.TransferInfo.t(), opts :: keyword) ::
          {:ok, AdyenEx.Transfer.V3.Transfer.t()}
          | {:error,
             AdyenEx.Transfer.V3.ServiceError.t()
             | AdyenEx.Transfer.V3.TransferServiceRestServiceError.t()}
  def post_transfers(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {AdyenEx.Transfer.V3.Transfers, :post_transfers},
      url: "/transfers",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Transfer.V3.TransferInfo, :t}}],
      response: [
        {200, {AdyenEx.Transfer.V3.Transfer, :t}},
        {202, {AdyenEx.Transfer.V3.Transfer, :t}},
        {401, {AdyenEx.Transfer.V3.ServiceError, :t}},
        {403, {AdyenEx.Transfer.V3.TransferServiceRestServiceError, :t}},
        {422, {AdyenEx.Transfer.V3.TransferServiceRestServiceError, :t}},
        {500, {AdyenEx.Transfer.V3.TransferServiceRestServiceError, :t}}
      ],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  ...
  @spec post_transfers_approve(
          body :: AdyenEx.Transfer.V3.ApproveTransfersRequest.t(),
          opts :: keyword
        ) ::
          :ok
          | {:error,
  ...
  def post_transfers_approve(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Transfer.V3.Transfers, :post_transfers_approve},
      url: "/transfers/approve",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Transfer.V3.ApproveTransfersRequest, :t}}],
      response: [
        {200, :null},
        {401, {AdyenEx.Transfer.V3.ServiceError, :t}},
        {403, {AdyenEx.Transfer.V3.TransferServiceRestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_transfers_cancel(
          body :: AdyenEx.Transfer.V3.CancelTransfersRequest.t(),
          opts :: keyword
        ) :: :ok | {:error, AdyenEx.Transfer.V3.TransferServiceRestServiceError.t()}
  def post_transfers_cancel(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {AdyenEx.Transfer.V3.Transfers, :post_transfers_cancel},
      url: "/transfers/cancel",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Transfer.V3.CancelTransfersRequest, :t}}],
      response: [
        {200, :null},
        {401, {AdyenEx.Transfer.V3.TransferServiceRestServiceError, :t}},
        {403, {AdyenEx.Transfer.V3.TransferServiceRestServiceError, :t}},
        {422, {AdyenEx.Transfer.V3.TransferServiceRestServiceError, :t}},
        {500, {AdyenEx.Transfer.V3.TransferServiceRestServiceError, :t}}
      ],
  ...
  **Content Types**: `application/json`
  ...
  @spec post_transfers_transfer_id_returns(
          transferId :: String.t(),
          body :: AdyenEx.Transfer.V3.ReturnTransferRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Transfer.V3.ReturnTransferResponse.t()}
          | {:error, AdyenEx.Transfer.V3.TransferServiceRestServiceError.t()}
  def post_transfers_transfer_id_returns(transferId, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [transferId: transferId, body: body],
      call: {AdyenEx.Transfer.V3.Transfers, :post_transfers_transfer_id_returns},
      url: "/transfers/#{transferId}/returns",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Transfer.V3.ReturnTransferRequest, :t}}],
      response: [
        {200, {AdyenEx.Transfer.V3.ReturnTransferResponse, :t}},
        {401, {AdyenEx.Transfer.V3.TransferServiceRestServiceError, :t}},
        {403, {AdyenEx.Transfer.V3.TransferServiceRestServiceError, :t}},
        {422, {AdyenEx.Transfer.V3.TransferServiceRestServiceError, :t}},
        {500, {AdyenEx.Transfer.V3.TransferServiceRestServiceError, :t}}
