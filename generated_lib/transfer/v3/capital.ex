defmodule AdyenEx.Transfer.V3.Capital do
  @moduledoc """
  ...
  @spec get_grants(opts :: keyword) ::
          {:ok, AdyenEx.Transfer.V3.CapitalGrants.t()}
  ...
  def get_grants(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {AdyenEx.Transfer.V3.Capital, :get_grants},
      url: "/grants",
      method: :get,
      query: query,
      response: [
        {200, {AdyenEx.Transfer.V3.CapitalGrants, :t}},
        {400, {AdyenEx.Transfer.V3.RestServiceError, :t}},
        {401, {AdyenEx.Transfer.V3.RestServiceError, :t}},
        {403, {AdyenEx.Transfer.V3.RestServiceError, :t}},
        {404, {AdyenEx.Transfer.V3.RestServiceError, :t}},
  ...
  @spec get_grants_id(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.Transfer.V3.CapitalGrant.t()}
          | {:error, AdyenEx.Transfer.V3.RestServiceError.t()}
  def get_grants_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.Transfer.V3.Capital, :get_grants_id},
      url: "/grants/#{id}",
      method: :get,
      response: [
        {200, {AdyenEx.Transfer.V3.CapitalGrant, :t}},
        {400, {AdyenEx.Transfer.V3.RestServiceError, :t}},
        {401, {AdyenEx.Transfer.V3.RestServiceError, :t}},
        {403, {AdyenEx.Transfer.V3.RestServiceError, :t}},
        {404, {AdyenEx.Transfer.V3.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_grants(body :: AdyenEx.Transfer.V3.CapitalGrantInfo.t(), opts :: keyword) ::
          {:ok, AdyenEx.Transfer.V3.CapitalGrant.t()}
          | {:error, AdyenEx.Transfer.V3.RestServiceError.t()}
  def post_grants(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Transfer.V3.Capital, :post_grants},
      url: "/grants",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Transfer.V3.CapitalGrantInfo, :t}}],
      response: [
        {200, {AdyenEx.Transfer.V3.CapitalGrant, :t}},
        {400, {AdyenEx.Transfer.V3.RestServiceError, :t}},
        {401, {AdyenEx.Transfer.V3.RestServiceError, :t}},
