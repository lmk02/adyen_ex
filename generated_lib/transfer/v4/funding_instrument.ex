defmodule AdyenEx.Transfer.V4.FundingInstrument do
  @moduledoc """
  Provides struct and type for a FundingInstrument
  """

  @type t :: %__MODULE__{
          cardIdentification: AdyenEx.Transfer.V4.CardIdentification.t() | nil,
  ...
  def __fields__(:t) do
    [
      cardIdentification: {AdyenEx.Transfer.V4.CardIdentification, :t},
