defmodule Adyen.Transfer.V4.Transactions do
  @moduledoc """
  ...
  @spec get_transactions(opts :: keyword) ::
          {:ok, Adyen.Transfer.V4.TransactionSearchResponse.t()}
  ...
  def get_transactions(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.Transfer.V4.Transactions, :get_transactions},
      url: "/transactions",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.Transfer.V4.TransactionSearchResponse, :t}},
  ...
  @spec get_transactions_id(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Transfer.V4.Transaction.t()}
          | {:error, Adyen.Transfer.V4.RestServiceError.t()}
  def get_transactions_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.Transfer.V4.Transactions, :get_transactions_id},
      url: "/transactions/#{id}",
      method: :get,
      response: [
        {200, {Adyen.Transfer.V4.Transaction, :t}},
        {401, {Adyen.Transfer.V4.RestServiceError, :t}},
        {403, {Adyen.Transfer.V4.RestServiceError, :t}},
        {422, {Adyen.Transfer.V4.RestServiceError, :t}},
        {500, {Adyen.Transfer.V4.RestServiceError, :t}}
