defmodule AdyenEx.Transfer.V4.Transactions do
  @moduledoc """
  ...
  @spec get_transactions(opts :: keyword) ::
          {:ok, AdyenEx.Transfer.V4.TransactionSearchResponse.t()}
  ...
  def get_transactions(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {AdyenEx.Transfer.V4.Transactions, :get_transactions},
      url: "/transactions",
      method: :get,
      query: query,
      response: [
        {200, {AdyenEx.Transfer.V4.TransactionSearchResponse, :t}},
  ...
  @spec get_transactions_id(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.Transfer.V4.Transaction.t()}
          | {:error, AdyenEx.Transfer.V4.RestServiceError.t()}
  def get_transactions_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.Transfer.V4.Transactions, :get_transactions_id},
      url: "/transactions/#{id}",
      method: :get,
      response: [
        {200, {AdyenEx.Transfer.V4.Transaction, :t}},
        {401, {AdyenEx.Transfer.V4.RestServiceError, :t}},
        {403, {AdyenEx.Transfer.V4.RestServiceError, :t}},
        {422, {AdyenEx.Transfer.V4.RestServiceError, :t}},
        {500, {AdyenEx.Transfer.V4.RestServiceError, :t}}
