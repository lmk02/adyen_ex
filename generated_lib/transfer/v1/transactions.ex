defmodule AdyenEx.Transfer.V1.Transactions do
  @moduledoc """
  ...
  @spec get_transactions(opts :: keyword) ::
          {:ok, AdyenEx.Transfer.V1.TransactionSearchResponse.t()}
          | {:error, AdyenEx.Transfer.V1.RestServiceError.t()}
  def get_transactions(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {AdyenEx.Transfer.V1.Transactions, :get_transactions},
      url: "/transactions",
      method: :get,
      query: query,
      response: [
        {200, {AdyenEx.Transfer.V1.TransactionSearchResponse, :t}},
        {401, {AdyenEx.Transfer.V1.RestServiceError, :t}},
        {403, {AdyenEx.Transfer.V1.RestServiceError, :t}},
        {422, {AdyenEx.Transfer.V1.RestServiceError, :t}},
        {500, {AdyenEx.Transfer.V1.RestServiceError, :t}}
      ],
      opts: opts
    })
  end
  ...
  @spec get_transactions_id(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.Transfer.V1.Transaction.t()}
          | {:error, AdyenEx.Transfer.V1.RestServiceError.t()}
  def get_transactions_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.Transfer.V1.Transactions, :get_transactions_id},
      url: "/transactions/#{id}",
      method: :get,
      response: [
        {200, {AdyenEx.Transfer.V1.Transaction, :t}},
        {401, {AdyenEx.Transfer.V1.RestServiceError, :t}},
        {403, {AdyenEx.Transfer.V1.RestServiceError, :t}},
        {422, {AdyenEx.Transfer.V1.RestServiceError, :t}},
        {500, {AdyenEx.Transfer.V1.RestServiceError, :t}}
