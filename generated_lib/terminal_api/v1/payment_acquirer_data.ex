defmodule AdyenEx.TerminalAPI.V1.PaymentAcquirerData do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          AcquirerTransactionID: AdyenEx.TerminalAPI.V1.TransactionIDType.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      AcquirerTransactionID: {AdyenEx.TerminalAPI.V1.TransactionIDType, :t},
      ApprovalCode: :string,
