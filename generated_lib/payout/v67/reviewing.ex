defmodule AdyenEx.Payout.V67.Reviewing do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_confirm_third_party(body :: AdyenEx.Payout.V67.ModifyRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payout.V67.ModifyResponse.t()}
  ...
  def post_confirm_third_party(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payout.V67.Reviewing, :post_confirm_third_party},
      url: "/confirmThirdParty",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payout.V67.ModifyRequest, :t}}],
      response: [
        {200, {AdyenEx.Payout.V67.ModifyResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_decline_third_party(body :: AdyenEx.Payout.V67.ModifyRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payout.V67.ModifyResponse.t()}
          | {:error, AdyenEx.Payout.V67.ServiceError.t()}
  def post_decline_third_party(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payout.V67.Reviewing, :post_decline_third_party},
