defmodule AdyenEx.Payout.V52.PayoutRequest do
  @moduledoc """
  Provides struct and type for a PayoutRequest
  """

  @type t :: %__MODULE__{
          amount: AdyenEx.Payout.V52.Amount.t(),
          billingAddress: AdyenEx.Payout.V52.Address.t() | nil,
          card: AdyenEx.Payout.V52.Card.t() | nil,
          fraudOffset: integer | nil,
          fundSource: AdyenEx.Payout.V52.FundSource.t() | nil,
          merchantAccount: String.t(),
          recurring: AdyenEx.Payout.V52.Recurring.t() | nil,
          reference: String.t(),
  ...
  def __fields__(:t) do
    [
      ...
      fundSource: {AdyenEx.Payout.V52.FundSource, :t},
