defmodule AdyenEx.Payout.V50.InstantPayouts do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_payout(body :: AdyenEx.Payout.V50.PayoutRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payout.V50.PayoutResponse.t()}
  ...
  def post_payout(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payout.V50.InstantPayouts, :post_payout},
      url: "/payout",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payout.V50.PayoutRequest, :t}}],
      response: [
        {200, {AdyenEx.Payout.V50.PayoutResponse, :t}},
