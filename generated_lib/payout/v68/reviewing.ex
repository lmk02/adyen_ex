defmodule AdyenEx.Payout.V68.Reviewing do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_confirm_third_party(body :: AdyenEx.Payout.V68.ModifyRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payout.V68.ModifyResponse.t()}
  ...
  def post_confirm_third_party(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payout.V68.Reviewing, :post_confirm_third_party},
      url: "/confirmThirdParty",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payout.V68.ModifyRequest, :t}}],
      response: [
        {200, {AdyenEx.Payout.V68.ModifyResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_decline_third_party(body :: AdyenEx.Payout.V68.ModifyRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payout.V68.ModifyResponse.t()}
          | {:error, AdyenEx.Payout.V68.ServiceError.t()}
  def post_decline_third_party(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payout.V68.Reviewing, :post_decline_third_party},
