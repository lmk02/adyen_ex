defmodule Adyen.Payout.V68.InstantPayouts do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_payout(body :: Adyen.Payout.V68.PayoutRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Payout.V68.PayoutResponse.t()} | {:error, Adyen.Payout.V68.ServiceError.t()}
  def post_payout(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Payout.V68.InstantPayouts, :post_payout},
      url: "/payout",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payout.V68.PayoutRequest, :t}}],
      response: [
        {200, {Adyen.Payout.V68.PayoutResponse, :t}},
