defmodule AdyenEx.Payout.V68.Initialization do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_store_detail(body :: AdyenEx.Payout.V68.StoreDetailRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payout.V68.StoreDetailResponse.t()}
          | {:error, AdyenEx.Payout.V68.ServiceError.t()}
  def post_store_detail(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payout.V68.Initialization, :post_store_detail},
      url: "/storeDetail",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payout.V68.StoreDetailRequest, :t}}],
      response: [
        {200, {AdyenEx.Payout.V68.StoreDetailResponse, :t}},
        {400, {AdyenEx.Payout.V68.ServiceError, :t}},
        {401, {AdyenEx.Payout.V68.ServiceError, :t}},
        {403, {AdyenEx.Payout.V68.ServiceError, :t}},
        {422, {AdyenEx.Payout.V68.ServiceError, :t}},
        {500, {AdyenEx.Payout.V68.ServiceError, :t}}
      ],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  ...
  @spec post_store_detail_and_submit_third_party(
          body :: AdyenEx.Payout.V68.StoreDetailAndSubmitRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Payout.V68.StoreDetailAndSubmitResponse.t()}
          | {:error, AdyenEx.Payout.V68.ServiceError.t()}
  def post_store_detail_and_submit_third_party(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payout.V68.Initialization, :post_store_detail_and_submit_third_party},
      url: "/storeDetailAndSubmitThirdParty",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payout.V68.StoreDetailAndSubmitRequest, :t}}],
      response: [
        {200, {AdyenEx.Payout.V68.StoreDetailAndSubmitResponse, :t}},
        {400, {AdyenEx.Payout.V68.ServiceError, :t}},
        {401, {AdyenEx.Payout.V68.ServiceError, :t}},
        {403, {AdyenEx.Payout.V68.ServiceError, :t}},
        {422, {AdyenEx.Payout.V68.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_submit_third_party(body :: AdyenEx.Payout.V68.SubmitRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payout.V68.SubmitResponse.t()}
          | {:error, AdyenEx.Payout.V68.ServiceError.t()}
  def post_submit_third_party(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payout.V68.Initialization, :post_submit_third_party},
      url: "/submitThirdParty",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payout.V68.SubmitRequest, :t}}],
      response: [
        {200, {AdyenEx.Payout.V68.SubmitResponse, :t}},
        {400, {AdyenEx.Payout.V68.ServiceError, :t}},
        {401, {AdyenEx.Payout.V68.ServiceError, :t}},
        {403, {AdyenEx.Payout.V68.ServiceError, :t}},
        {422, {AdyenEx.Payout.V68.ServiceError, :t}},
