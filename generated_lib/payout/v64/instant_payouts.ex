defmodule AdyenEx.Payout.V64.InstantPayouts do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_payout(body :: AdyenEx.Payout.V64.PayoutRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Payout.V64.PayoutResponse.t()}
  ...
  def post_payout(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Payout.V64.InstantPayouts, :post_payout},
      url: "/payout",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Payout.V64.PayoutRequest, :t}}],
      response: [
        {200, {AdyenEx.Payout.V64.PayoutResponse, :t}},
