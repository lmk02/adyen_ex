defmodule Adyen.Payout.V64.InstantPayouts do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_payout(body :: Adyen.Payout.V64.PayoutRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Payout.V64.PayoutResponse.t()} | {:error, Adyen.Payout.V64.ServiceError.t()}
  def post_payout(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Payout.V64.InstantPayouts, :post_payout},
      url: "/payout",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payout.V64.PayoutRequest, :t}}],
      response: [
        {200, {Adyen.Payout.V64.PayoutResponse, :t}},
