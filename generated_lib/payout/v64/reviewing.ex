defmodule Adyen.Payout.V64.Reviewing do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  """
  @spec post_confirm_third_party(body :: Adyen.Payout.V64.ModifyRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Payout.V64.ModifyResponse.t()} | {:error, Adyen.Payout.V64.ServiceError.t()}
  def post_confirm_third_party(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Adyen.Payout.V64.Reviewing, :post_confirm_third_party},
      url: "/confirmThirdParty",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Payout.V64.ModifyRequest, :t}}],
      response: [
        {200, {Adyen.Payout.V64.ModifyResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_decline_third_party(body :: Adyen.Payout.V64.ModifyRequest.t(), opts :: keyword) ::
          {:ok, Adyen.Payout.V64.ModifyResponse.t()} | {:error, Adyen.Payout.V64.ServiceError.t()}
  def post_decline_third_party(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Payout.V64.Reviewing, :post_decline_third_party},
