defmodule AdyenEx.LegalEntity.V4.VerificationError do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          remediatingActions: [AdyenEx.LegalEntity.V4.RemediatingAction.t()] | nil,
          subErrors: [AdyenEx.LegalEntity.V4.VerificationErrorRecursive.t()] | nil,
          type: String.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      code: :string,
      message: :string,
      remediatingActions: [{AdyenEx.LegalEntity.V4.RemediatingAction, :t}],
      subErrors: [{AdyenEx.LegalEntity.V4.VerificationErrorRecursive, :t}],
