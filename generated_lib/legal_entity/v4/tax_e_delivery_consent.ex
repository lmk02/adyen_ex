defmodule AdyenEx.LegalEntity.V4.TaxEDeliveryConsent do
  @moduledoc """
  ...
  @spec post_legal_entities_id_check_tax_electronic_delivery_consent(
          ...
          {:ok, AdyenEx.LegalEntity.V4.CheckTaxElectronicDeliveryConsentResponse.t()}
  ...
  **Content Types**: `application/json`
  ...
  @spec post_legal_entities_id_set_tax_electronic_delivery_consent(
          id :: String.t(),
          body :: AdyenEx.LegalEntity.V4.SetTaxElectronicDeliveryConsentRequest.t(),
          opts :: keyword
  ...
  def post_legal_entities_id_set_tax_electronic_delivery_consent(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :post,
      request: [
        {"application/json", {AdyenEx.LegalEntity.V4.SetTaxElectronicDeliveryConsentRequest, :t}}
      ],
      response: [
        {200, :null},
        {400, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
