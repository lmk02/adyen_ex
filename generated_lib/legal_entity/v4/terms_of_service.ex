defmodule AdyenEx.LegalEntity.V4.TermsOfService do
  @moduledoc """
  ...
  @spec get_legal_entities_id_accepted_terms_of_service_document_termsofserviceacceptancereference(
          ...
          {:ok, AdyenEx.LegalEntity.V4.GetAcceptedTermsOfServiceDocumentResponse.t()}
  ...
  def get_legal_entities_id_accepted_terms_of_service_document_termsofserviceacceptancereference(
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.LegalEntity.V4.TermsOfService,
      ...
      query: query,
      response: [
        {200, {AdyenEx.LegalEntity.V4.GetAcceptedTermsOfServiceDocumentResponse, :t}},
  ...
  @spec get_legal_entities_id_terms_of_service_acceptance_infos(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.LegalEntity.V4.GetTermsOfServiceAcceptanceInfosResponse.t()}
          | {:error, AdyenEx.LegalEntity.V4.ServiceError.t()}
  def get_legal_entities_id_terms_of_service_acceptance_infos(id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      response: [
        {200, {AdyenEx.LegalEntity.V4.GetTermsOfServiceAcceptanceInfosResponse, :t}},
        {400, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
  ...
  @spec get_legal_entities_id_terms_of_service_status(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.LegalEntity.V4.CalculateTermsOfServiceStatusResponse.t()}
          | {:error, AdyenEx.LegalEntity.V4.ServiceError.t()}
  def get_legal_entities_id_terms_of_service_status(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call:
        {AdyenEx.LegalEntity.V4.TermsOfService, :get_legal_entities_id_terms_of_service_status},
      url: "/legalEntities/#{id}/termsOfServiceStatus",
      method: :get,
      response: [
        {200, {AdyenEx.LegalEntity.V4.CalculateTermsOfServiceStatusResponse, :t}},
        {400, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_legal_entities_id_terms_of_service_termsofservicedocumentid(
          ...
          body :: AdyenEx.LegalEntity.V4.AcceptTermsOfServiceRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.LegalEntity.V4.AcceptTermsOfServiceResponse.t()}
          | {:error, AdyenEx.LegalEntity.V4.ServiceError.t()}
  def patch_legal_entities_id_terms_of_service_termsofservicedocumentid(
    ...
    client.request(%{
      ...
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.LegalEntity.V4.AcceptTermsOfServiceRequest, :t}}],
      response: [
        {200, {AdyenEx.LegalEntity.V4.AcceptTermsOfServiceResponse, :t}},
        {400, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_legal_entities_id_terms_of_service(
          id :: String.t(),
          body :: AdyenEx.LegalEntity.V4.GetTermsOfServiceDocumentRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.LegalEntity.V4.GetTermsOfServiceDocumentResponse.t()}
          | {:error, AdyenEx.LegalEntity.V4.ServiceError.t()}
  def post_legal_entities_id_terms_of_service(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.LegalEntity.V4.TermsOfService, :post_legal_entities_id_terms_of_service},
      url: "/legalEntities/#{id}/termsOfService",
      body: body,
      method: :post,
      request: [
        {"application/json", {AdyenEx.LegalEntity.V4.GetTermsOfServiceDocumentRequest, :t}}
      ],
      response: [
        {200, {AdyenEx.LegalEntity.V4.GetTermsOfServiceDocumentResponse, :t}},
        {400, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
