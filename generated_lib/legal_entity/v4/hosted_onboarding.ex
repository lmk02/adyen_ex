defmodule AdyenEx.LegalEntity.V4.HostedOnboarding do
  @moduledoc """
  ...
  @spec get_themes(opts :: keyword) ::
          {:ok, AdyenEx.LegalEntity.V4.OnboardingThemes.t()}
  ...
  def get_themes(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {AdyenEx.LegalEntity.V4.HostedOnboarding, :get_themes},
      url: "/themes",
      method: :get,
      response: [
        {200, {AdyenEx.LegalEntity.V4.OnboardingThemes, :t}},
  ...
  @spec get_themes_id(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.LegalEntity.V4.OnboardingTheme.t()}
          | {:error, AdyenEx.LegalEntity.V4.ServiceError.t()}
  def get_themes_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.LegalEntity.V4.HostedOnboarding, :get_themes_id},
      url: "/themes/#{id}",
      method: :get,
      response: [
        {200, {AdyenEx.LegalEntity.V4.OnboardingTheme, :t}},
        {400, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_legal_entities_id_onboarding_links(
          id :: String.t(),
          body :: AdyenEx.LegalEntity.V4.OnboardingLinkInfo.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.LegalEntity.V4.OnboardingLink.t()}
          | {:error, AdyenEx.LegalEntity.V4.ServiceError.t()}
  def post_legal_entities_id_onboarding_links(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.LegalEntity.V4.HostedOnboarding, :post_legal_entities_id_onboarding_links},
      url: "/legalEntities/#{id}/onboardingLinks",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.LegalEntity.V4.OnboardingLinkInfo, :t}}],
      response: [
        {200, {AdyenEx.LegalEntity.V4.OnboardingLink, :t}},
        {400, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
