defmodule AdyenEx.LegalEntity.V4.LegalEntities do
  @moduledoc """
  ...
  @spec get_legal_entities_id(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.LegalEntity.V4.LegalEntity.t()}
  ...
  def get_legal_entities_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.LegalEntity.V4.LegalEntities, :get_legal_entities_id},
      url: "/legalEntities/#{id}",
      method: :get,
      response: [
        {200, {AdyenEx.LegalEntity.V4.LegalEntity, :t}},
  ...
  @spec get_legal_entities_id_business_lines(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.LegalEntity.V4.BusinessLines.t()}
          | {:error, AdyenEx.LegalEntity.V4.ServiceError.t()}
  def get_legal_entities_id_business_lines(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.LegalEntity.V4.LegalEntities, :get_legal_entities_id_business_lines},
      url: "/legalEntities/#{id}/businessLines",
      method: :get,
      response: [
        {200, {AdyenEx.LegalEntity.V4.BusinessLines, :t}},
        {400, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_legal_entities_id(
          id :: String.t(),
          body :: AdyenEx.LegalEntity.V4.LegalEntityInfo.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.LegalEntity.V4.LegalEntity.t()}
          | {:error, AdyenEx.LegalEntity.V4.ServiceError.t()}
  def patch_legal_entities_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.LegalEntity.V4.LegalEntities, :patch_legal_entities_id},
      url: "/legalEntities/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.LegalEntity.V4.LegalEntityInfo, :t}}],
      response: [
        {200, {AdyenEx.LegalEntity.V4.LegalEntity, :t}},
        {400, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_legal_entities(
          body :: AdyenEx.LegalEntity.V4.LegalEntityInfoRequiredType.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.LegalEntity.V4.LegalEntity.t()}
          | {:error, AdyenEx.LegalEntity.V4.ServiceError.t()}
  def post_legal_entities(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.LegalEntity.V4.LegalEntities, :post_legal_entities},
      url: "/legalEntities",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.LegalEntity.V4.LegalEntityInfoRequiredType, :t}}],
      response: [
        {200, {AdyenEx.LegalEntity.V4.LegalEntity, :t}},
        {400, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
  ...
  @spec post_legal_entities_id_check_verification_errors(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.LegalEntity.V4.VerificationErrors.t()}
          | {:error, AdyenEx.LegalEntity.V4.ServiceError.t()}
  def post_legal_entities_id_check_verification_errors(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call:
        {AdyenEx.LegalEntity.V4.LegalEntities, :post_legal_entities_id_check_verification_errors},
      url: "/legalEntities/#{id}/checkVerificationErrors",
      method: :post,
      response: [
        {200, {AdyenEx.LegalEntity.V4.VerificationErrors, :t}},
        {400, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
  ...
  @spec post_legal_entities_id_confirm_data_review(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.LegalEntity.V4.DataReviewConfirmationResponse.t()}
          | {:error, AdyenEx.LegalEntity.V4.ServiceError.t()}
  def post_legal_entities_id_confirm_data_review(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.LegalEntity.V4.LegalEntities, :post_legal_entities_id_confirm_data_review},
      url: "/legalEntities/#{id}/confirmDataReview",
      method: :post,
      response: [
        {200, {AdyenEx.LegalEntity.V4.DataReviewConfirmationResponse, :t}},
        {400, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V4.ServiceError, :t}},
  ...
  def post_legal_entities_id_request_periodic_review(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call:
        {AdyenEx.LegalEntity.V4.LegalEntities, :post_legal_entities_id_request_periodic_review},
