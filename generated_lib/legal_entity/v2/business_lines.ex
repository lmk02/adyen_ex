defmodule AdyenEx.LegalEntity.V2.BusinessLines do
  @moduledoc """
  ...
  def delete_business_lines_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.LegalEntity.V2.BusinessLines, :delete_business_lines_id},
  ...
  @spec get_business_lines_id(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.LegalEntity.V2.BusinessLine.t()}
  ...
  def get_business_lines_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.LegalEntity.V2.BusinessLines, :get_business_lines_id},
      url: "/businessLines/#{id}",
      method: :get,
      response: [
        {200, {AdyenEx.LegalEntity.V2.BusinessLine, :t}},
        {400, {AdyenEx.LegalEntity.V2.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V2.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V2.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V2.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_business_lines_id(
          id :: String.t(),
          body :: AdyenEx.LegalEntity.V2.BusinessLineInfoUpdate.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.LegalEntity.V2.BusinessLine.t()}
          | {:error, AdyenEx.LegalEntity.V2.ServiceError.t()}
  def patch_business_lines_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.LegalEntity.V2.BusinessLines, :patch_business_lines_id},
      url: "/businessLines/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.LegalEntity.V2.BusinessLineInfoUpdate, :t}}],
      response: [
        {200, {AdyenEx.LegalEntity.V2.BusinessLine, :t}},
        {400, {AdyenEx.LegalEntity.V2.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V2.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_business_lines(body :: AdyenEx.LegalEntity.V2.BusinessLineInfo.t(), opts :: keyword) ::
          {:ok, AdyenEx.LegalEntity.V2.BusinessLine.t()}
          | {:error, AdyenEx.LegalEntity.V2.ServiceError.t()}
  def post_business_lines(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.LegalEntity.V2.BusinessLines, :post_business_lines},
      url: "/businessLines",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.LegalEntity.V2.BusinessLineInfo, :t}}],
      response: [
        {200, {AdyenEx.LegalEntity.V2.BusinessLine, :t}},
        {400, {AdyenEx.LegalEntity.V2.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V2.ServiceError, :t}},
  ...
  @type t :: %__MODULE__{businessLines: [AdyenEx.LegalEntity.V2.BusinessLine.t()]}
  ...
  def __fields__(:t) do
    [businessLines: [{AdyenEx.LegalEntity.V2.BusinessLine, :t}]]
  end
end
