defmodule Adyen.LegalEntity.V2.TransferInstruments do
  @moduledoc """
  ...
  def delete_transfer_instruments_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.V2.TransferInstruments, :delete_transfer_instruments_id},
  ...
  @spec get_transfer_instruments_id(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.V2.TransferInstrument.t()}
  ...
  def get_transfer_instruments_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.V2.TransferInstruments, :get_transfer_instruments_id},
      url: "/transferInstruments/#{id}",
      method: :get,
      response: [
        {200, {Adyen.LegalEntity.V2.TransferInstrument, :t}},
        {400, {Adyen.LegalEntity.V2.ServiceError, :t}},
        {401, {Adyen.LegalEntity.V2.ServiceError, :t}},
        {403, {Adyen.LegalEntity.V2.ServiceError, :t}},
        {422, {Adyen.LegalEntity.V2.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_transfer_instruments_id(
          id :: String.t(),
          body :: Adyen.LegalEntity.V2.TransferInstrumentInfo.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.LegalEntity.V2.TransferInstrument.t()}
          | {:error, Adyen.LegalEntity.V2.ServiceError.t()}
  def patch_transfer_instruments_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.LegalEntity.V2.TransferInstruments, :patch_transfer_instruments_id},
      url: "/transferInstruments/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.LegalEntity.V2.TransferInstrumentInfo, :t}}],
      response: [
        {200, {Adyen.LegalEntity.V2.TransferInstrument, :t}},
        {400, {Adyen.LegalEntity.V2.ServiceError, :t}},
        {401, {Adyen.LegalEntity.V2.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  def post_transfer_instruments(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.LegalEntity.V2.TransferInstruments, :post_transfer_instruments},
