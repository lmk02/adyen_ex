defmodule Adyen.LegalEntity.V2.TaxEDeliveryConsent do
  @moduledoc """
  ...
  @spec post_legal_entities_id_check_tax_electronic_delivery_consent(
          ...
          {:ok, Adyen.LegalEntity.V2.CheckTaxElectronicDeliveryConsentResponse.t()}
  ...
  **Content Types**: `application/json`
  ...
  @spec post_legal_entities_id_set_tax_electronic_delivery_consent(
          id :: String.t(),
          body :: Adyen.LegalEntity.V2.SetTaxElectronicDeliveryConsentRequest.t(),
          opts :: keyword
  ...
  def post_legal_entities_id_set_tax_electronic_delivery_consent(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :post,
      request: [
        {"application/json", {Adyen.LegalEntity.V2.SetTaxElectronicDeliveryConsentRequest, :t}}
      ],
      response: [
        {200, :null},
        {400, {Adyen.LegalEntity.V2.ServiceError, :t}},
