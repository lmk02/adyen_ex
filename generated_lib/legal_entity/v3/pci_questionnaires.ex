defmodule AdyenEx.LegalEntity.V3.PCIQuestionnaires do
  @moduledoc """
  ...
  @spec get_legal_entities_id_pci_questionnaires(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.LegalEntity.V3.GetPciQuestionnaireInfosResponse.t()}
  ...
  def get_legal_entities_id_pci_questionnaires(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.LegalEntity.V3.PCIQuestionnaires, :get_legal_entities_id_pci_questionnaires},
      url: "/legalEntities/#{id}/pciQuestionnaires",
      method: :get,
      response: [
        {200, {AdyenEx.LegalEntity.V3.GetPciQuestionnaireInfosResponse, :t}},
  ...
  @spec get_legal_entities_id_pci_questionnaires_pciid(
          ...
          {:ok, AdyenEx.LegalEntity.V3.GetPciQuestionnaireResponse.t()}
          | {:error, AdyenEx.LegalEntity.V3.ServiceError.t()}
  def get_legal_entities_id_pci_questionnaires_pciid(id, pciid, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.LegalEntity.V3.PCIQuestionnaires,
         :get_legal_entities_id_pci_questionnaires_pciid},
      url: "/legalEntities/#{id}/pciQuestionnaires/#{pciid}",
      method: :get,
      response: [
        {200, {AdyenEx.LegalEntity.V3.GetPciQuestionnaireResponse, :t}},
        {400, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_legal_entities_id_pci_questionnaires_generate_pci_templates(
          id :: String.t(),
          body :: AdyenEx.LegalEntity.V3.GeneratePciDescriptionRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.LegalEntity.V3.GeneratePciDescriptionResponse.t()}
          | {:error, AdyenEx.LegalEntity.V3.ServiceError.t()}
  def post_legal_entities_id_pci_questionnaires_generate_pci_templates(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.LegalEntity.V3.GeneratePciDescriptionRequest, :t}}],
      response: [
        {200, {AdyenEx.LegalEntity.V3.GeneratePciDescriptionResponse, :t}},
        {400, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_legal_entities_id_pci_questionnaires_sign_pci_templates(
          id :: String.t(),
          body :: AdyenEx.LegalEntity.V3.PciSigningRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.LegalEntity.V3.PciSigningResponse.t()}
          | {:error, AdyenEx.LegalEntity.V3.ServiceError.t()}
  def post_legal_entities_id_pci_questionnaires_sign_pci_templates(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.LegalEntity.V3.PciSigningRequest, :t}}],
      response: [
        {200, {AdyenEx.LegalEntity.V3.PciSigningResponse, :t}},
        {400, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_legal_entities_id_pci_questionnaires_signing_required(
          id :: String.t(),
          body :: AdyenEx.LegalEntity.V3.CalculatePciStatusRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.LegalEntity.V3.CalculatePciStatusResponse.t()}
          | {:error, AdyenEx.LegalEntity.V3.ServiceError.t()}
  def post_legal_entities_id_pci_questionnaires_signing_required(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.LegalEntity.V3.CalculatePciStatusRequest, :t}}],
      response: [
        {200, {AdyenEx.LegalEntity.V3.CalculatePciStatusResponse, :t}},
        {400, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
