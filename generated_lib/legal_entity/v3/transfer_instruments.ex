defmodule AdyenEx.LegalEntity.V3.TransferInstruments do
  @moduledoc """
  ...
  def delete_transfer_instruments_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.LegalEntity.V3.TransferInstruments, :delete_transfer_instruments_id},
  ...
  @spec get_transfer_instruments_id(id :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.LegalEntity.V3.TransferInstrument.t()}
  ...
  def get_transfer_instruments_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.LegalEntity.V3.TransferInstruments, :get_transfer_instruments_id},
      url: "/transferInstruments/#{id}",
      method: :get,
      response: [
        {200, {AdyenEx.LegalEntity.V3.TransferInstrument, :t}},
        {400, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {403, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {422, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_transfer_instruments_id(
          id :: String.t(),
          body :: AdyenEx.LegalEntity.V3.TransferInstrumentInfo.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.LegalEntity.V3.TransferInstrument.t()}
          | {:error, AdyenEx.LegalEntity.V3.ServiceError.t()}
  def patch_transfer_instruments_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.LegalEntity.V3.TransferInstruments, :patch_transfer_instruments_id},
      url: "/transferInstruments/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.LegalEntity.V3.TransferInstrumentInfo, :t}}],
      response: [
        {200, {AdyenEx.LegalEntity.V3.TransferInstrument, :t}},
        {400, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
        {401, {AdyenEx.LegalEntity.V3.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  def post_transfer_instruments(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.LegalEntity.V3.TransferInstruments, :post_transfer_instruments},
