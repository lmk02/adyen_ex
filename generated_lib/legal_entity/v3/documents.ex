defmodule Adyen.LegalEntity.V3.Documents do
  @moduledoc """
  ...
  def delete_documents_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.V3.Documents, :delete_documents_id},
      url: "/documents/#{id}",
      method: :delete,
      response: [
        {204, :null},
  ...
  @spec get_documents_id(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.V3.Document.t()}
  ...
  def get_documents_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.V3.Documents, :get_documents_id},
      url: "/documents/#{id}",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.LegalEntity.V3.Document, :t}},
        {400, {Adyen.LegalEntity.V3.ServiceError, :t}},
        {401, {Adyen.LegalEntity.V3.ServiceError, :t}},
        {403, {Adyen.LegalEntity.V3.ServiceError, :t}},
        {422, {Adyen.LegalEntity.V3.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_documents_id(
          id :: String.t(),
          body :: Adyen.LegalEntity.V3.Document.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.LegalEntity.V3.Document.t()}
          | {:error, Adyen.LegalEntity.V3.ServiceError.t()}
  def patch_documents_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.LegalEntity.V3.Documents, :patch_documents_id},
      url: "/documents/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.LegalEntity.V3.Document, :t}}],
      response: [
        {200, {Adyen.LegalEntity.V3.Document, :t}},
        {400, {Adyen.LegalEntity.V3.ServiceError, :t}},
        {401, {Adyen.LegalEntity.V3.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_documents(body :: Adyen.LegalEntity.V3.Document.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.V3.Document.t()}
          | {:error, Adyen.LegalEntity.V3.ServiceError.t()}
  def post_documents(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.LegalEntity.V3.Documents, :post_documents},
      url: "/documents",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.LegalEntity.V3.Document, :t}}],
