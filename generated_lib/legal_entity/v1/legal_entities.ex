defmodule Adyen.LegalEntity.V1.LegalEntities do
  @moduledoc """
  ...
  @spec get_legal_entities_id(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.V1.LegalEntity.t()}
  ...
  def get_legal_entities_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.V1.LegalEntities, :get_legal_entities_id},
      url: "/legalEntities/#{id}",
      method: :get,
      response: [
        {200, {Adyen.LegalEntity.V1.LegalEntity, :t}},
  ...
  @spec get_legal_entities_id_business_lines(id :: String.t(), opts :: keyword) ::
          {:ok, Adyen.LegalEntity.V1.BusinessLines.t()}
          | {:error, Adyen.LegalEntity.V1.ServiceError.t()}
  def get_legal_entities_id_business_lines(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Adyen.LegalEntity.V1.LegalEntities, :get_legal_entities_id_business_lines},
      url: "/legalEntities/#{id}/businessLines",
      method: :get,
      response: [
        {200, {Adyen.LegalEntity.V1.BusinessLines, :t}},
        {400, {Adyen.LegalEntity.V1.ServiceError, :t}},
        {401, {Adyen.LegalEntity.V1.ServiceError, :t}},
        {403, {Adyen.LegalEntity.V1.ServiceError, :t}},
        {422, {Adyen.LegalEntity.V1.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_legal_entities_id(
          id :: String.t(),
          body :: Adyen.LegalEntity.V1.LegalEntityInfo.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.LegalEntity.V1.LegalEntity.t()}
          | {:error, Adyen.LegalEntity.V1.ServiceError.t()}
  def patch_legal_entities_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.LegalEntity.V1.LegalEntities, :patch_legal_entities_id},
      url: "/legalEntities/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.LegalEntity.V1.LegalEntityInfo, :t}}],
      response: [
        {200, {Adyen.LegalEntity.V1.LegalEntity, :t}},
        {400, {Adyen.LegalEntity.V1.ServiceError, :t}},
        {401, {Adyen.LegalEntity.V1.ServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_legal_entities(
          body :: Adyen.LegalEntity.V1.LegalEntityInfoRequiredType.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.LegalEntity.V1.LegalEntity.t()}
          | {:error, Adyen.LegalEntity.V1.ServiceError.t()}
  def post_legal_entities(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.LegalEntity.V1.LegalEntities, :post_legal_entities},
      url: "/legalEntities",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.LegalEntity.V1.LegalEntityInfoRequiredType, :t}}],
      response: [
        {200, {Adyen.LegalEntity.V1.LegalEntity, :t}},
        {400, {Adyen.LegalEntity.V1.ServiceError, :t}},
        {401, {Adyen.LegalEntity.V1.ServiceError, :t}},
