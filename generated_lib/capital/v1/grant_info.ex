defmodule AdyenEx.Capital.V1.GrantInfo do
  @moduledoc """
  Provides struct and type for a GrantInfo
  """

  @type t :: %__MODULE__{
          counterparty: AdyenEx.Capital.V1.GrantInfoCounterparty.t() | nil,
  ...
  def __fields__(:t) do
    [
      counterparty: {AdyenEx.Capital.V1.GrantInfoCounterparty, :t},
