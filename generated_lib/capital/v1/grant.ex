defmodule AdyenEx.Capital.V1.Grant do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          counterparty: AdyenEx.Capital.V1.GrantCounterparty.t() | nil,
          grantAccountId: String.t(),
          grantOfferId: String.t(),
          id: String.t(),
          status: AdyenEx.Capital.V1.Status.t()
        }
  ...
  def __fields__(:t) do
    [
      balances: {AdyenEx.Capital.V1.Balance, :t},
      counterparty: {AdyenEx.Capital.V1.GrantCounterparty, :t},
