defmodule Adyen.Transaction.V2.DisputeAttachments do
  @moduledoc """
  ...
  @spec delete_disputes_dispute_id_attachments_attachment_id(
          ...
          opts :: keyword
        ) :: :ok | {:error, Adyen.Transaction.V2.DefaultErrorResponseEntity.t()}
  def delete_disputes_dispute_id_attachments_attachment_id(disputeId, attachmentId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.Transaction.V2.DisputeAttachments,
  ...
  @spec get_disputes_dispute_id_attachments(disputeId :: String.t(), opts :: keyword) ::
          {:ok, [Adyen.Transaction.V2.DisputeAttachment.t()]}
  ...
  def get_disputes_dispute_id_attachments(disputeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Transaction.V2.DisputeAttachments, :get_disputes_dispute_id_attachments},
      url: "/disputes/#{disputeId}/attachments",
      method: :get,
      response: [
        {200, [{Adyen.Transaction.V2.DisputeAttachment, :t}]},
        {401, {Adyen.Transaction.V2.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.Transaction.V2.DefaultErrorResponseEntity, :t}},
        {422, {Adyen.Transaction.V2.DefaultErrorResponseEntity, :t}}
      ],
  ...
  **Content Types**: `application/json`
  ...
  @spec post_disputes_dispute_id_attachments(
          disputeId :: String.t(),
          body :: Adyen.Transaction.V2.DisputeAttachment.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Transaction.V2.AttachDocumentResponse.t()}
          | {:error, Adyen.Transaction.V2.DefaultErrorResponseEntity.t()}
  def post_disputes_dispute_id_attachments(disputeId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Transaction.V2.DisputeAttachments, :post_disputes_dispute_id_attachments},
      url: "/disputes/#{disputeId}/attachments",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Transaction.V2.DisputeAttachment, :t}}],
      response: [
        {200, {Adyen.Transaction.V2.AttachDocumentResponse, :t}},
        {401, {Adyen.Transaction.V2.DefaultErrorResponseEntity, :t}},
        {403, {Adyen.Transaction.V2.DefaultErrorResponseEntity, :t}},
        {422, {Adyen.Transaction.V2.DefaultErrorResponseEntity, :t}}
      ],
