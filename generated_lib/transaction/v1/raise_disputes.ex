defmodule AdyenEx.Transaction.V1.RaiseDisputes do
  @moduledoc """
  ...
  @spec get_disputes(opts :: keyword) ::
          {:ok, [[AdyenEx.Transaction.V1.DisputeResponse.t()]]}
          | {:error, AdyenEx.Transaction.V1.DefaultErrorResponseEntity.t()}
  def get_disputes(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {AdyenEx.Transaction.V1.RaiseDisputes, :get_disputes},
      url: "/disputes",
      method: :get,
      query: query,
      response: [
        {200, [[{AdyenEx.Transaction.V1.DisputeResponse, :t}]]},
        {401, {AdyenEx.Transaction.V1.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.Transaction.V1.DefaultErrorResponseEntity, :t}},
        {422, {AdyenEx.Transaction.V1.DefaultErrorResponseEntity, :t}}
      ],
      opts: opts
    })
  end
  ...
  def get_disputes_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.Transaction.V1.RaiseDisputes, :get_disputes_id},
      url: "/disputes/#{id}",
      method: :get,
      response: [
        {200, {AdyenEx.Transaction.V1.DisputeResponse, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_disputes_id(
          id :: String.t(),
          body :: AdyenEx.Transaction.V1.PatchableDisputeRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Transaction.V1.DisputeResponse.t()}
          | {:error, AdyenEx.Transaction.V1.DefaultErrorResponseEntity.t()}
  def patch_disputes_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.Transaction.V1.RaiseDisputes, :patch_disputes_id},
      url: "/disputes/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.Transaction.V1.PatchableDisputeRequest, :t}}],
      response: [
        {200, {AdyenEx.Transaction.V1.DisputeResponse, :t}},
        {401, {AdyenEx.Transaction.V1.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.Transaction.V1.DefaultErrorResponseEntity, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_disputes(body :: AdyenEx.Transaction.V1.DisputeRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.Transaction.V1.DisputeResponse.t()}
          | {:error, AdyenEx.Transaction.V1.DefaultErrorResponseEntity.t()}
  def post_disputes(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Transaction.V1.RaiseDisputes, :post_disputes},
      url: "/disputes",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Transaction.V1.DisputeRequest, :t}}],
      response: [
        {200, {AdyenEx.Transaction.V1.DisputeResponse, :t}},
        {401, {AdyenEx.Transaction.V1.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.Transaction.V1.DefaultErrorResponseEntity, :t}},
