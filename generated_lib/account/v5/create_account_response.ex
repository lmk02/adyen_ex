defmodule AdyenEx.Account.V5.CreateAccountResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          payoutSchedule: AdyenEx.Account.V5.PayoutScheduleResponse.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      payoutSchedule: {AdyenEx.Account.V5.PayoutScheduleResponse, :t},
