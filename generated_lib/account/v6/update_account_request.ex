defmodule AdyenEx.Account.V6.UpdateAccountRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          payoutSchedule: AdyenEx.Account.V6.UpdatePayoutScheduleRequest.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      payoutSchedule: {AdyenEx.Account.V6.UpdatePayoutScheduleRequest, :t},
