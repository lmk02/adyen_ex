defmodule AdyenEx.RaiseDisputes.V2.DisputeAttachments do
  @moduledoc """
  ...
  @spec delete_disputes_dispute_id_attachments_attachment_id(
          ...
          opts :: keyword
        ) :: :ok | {:error, AdyenEx.RaiseDisputes.V2.DefaultErrorResponseEntity.t()}
  def delete_disputes_dispute_id_attachments_attachment_id(disputeId, attachmentId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.RaiseDisputes.V2.DisputeAttachments,
  ...
  @spec get_disputes_dispute_id_attachments(disputeId :: String.t(), opts :: keyword) ::
          {:ok, [AdyenEx.RaiseDisputes.V2.DisputeAttachment.t()]}
  ...
  def get_disputes_dispute_id_attachments(disputeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.RaiseDisputes.V2.DisputeAttachments, :get_disputes_dispute_id_attachments},
      url: "/disputes/#{disputeId}/attachments",
      method: :get,
      response: [
        {200, [{AdyenEx.RaiseDisputes.V2.DisputeAttachment, :t}]},
        {401, {AdyenEx.RaiseDisputes.V2.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.RaiseDisputes.V2.DefaultErrorResponseEntity, :t}},
        {422, {AdyenEx.RaiseDisputes.V2.DefaultErrorResponseEntity, :t}}
      ],
  ...
  **Content Types**: `application/json`
  ...
  @spec post_disputes_dispute_id_attachments(
          disputeId :: String.t(),
          body :: AdyenEx.RaiseDisputes.V2.DisputeAttachment.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.RaiseDisputes.V2.AttachDocumentResponse.t()}
          | {:error, AdyenEx.RaiseDisputes.V2.DefaultErrorResponseEntity.t()}
  def post_disputes_dispute_id_attachments(disputeId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.RaiseDisputes.V2.DisputeAttachments, :post_disputes_dispute_id_attachments},
      url: "/disputes/#{disputeId}/attachments",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.RaiseDisputes.V2.DisputeAttachment, :t}}],
      response: [
        {200, {AdyenEx.RaiseDisputes.V2.AttachDocumentResponse, :t}},
        {401, {AdyenEx.RaiseDisputes.V2.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.RaiseDisputes.V2.DefaultErrorResponseEntity, :t}},
        {422, {AdyenEx.RaiseDisputes.V2.DefaultErrorResponseEntity, :t}}
      ],
