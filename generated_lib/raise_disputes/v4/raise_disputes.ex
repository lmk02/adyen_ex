defmodule AdyenEx.RaiseDisputes.V4.RaiseDisputes do
  @moduledoc """
  ...
  @spec get_disputes(opts :: keyword) ::
          {:ok, [[AdyenEx.RaiseDisputes.V4.DisputeResponse.t()]]}
          | {:error, AdyenEx.RaiseDisputes.V4.DefaultErrorResponseEntity.t()}
  def get_disputes(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {AdyenEx.RaiseDisputes.V4.RaiseDisputes, :get_disputes},
      url: "/disputes",
      method: :get,
      query: query,
      response: [
        {200, [[{AdyenEx.RaiseDisputes.V4.DisputeResponse, :t}]]},
        {401, {AdyenEx.RaiseDisputes.V4.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.RaiseDisputes.V4.DefaultErrorResponseEntity, :t}},
        {422, {AdyenEx.RaiseDisputes.V4.DefaultErrorResponseEntity, :t}}
      ],
      opts: opts
    })
  end
  ...
  def get_disputes_id(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {AdyenEx.RaiseDisputes.V4.RaiseDisputes, :get_disputes_id},
      url: "/disputes/#{id}",
      method: :get,
      response: [
        {200, {AdyenEx.RaiseDisputes.V4.DisputeResponse, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_disputes_id(
          id :: String.t(),
          body :: AdyenEx.RaiseDisputes.V4.PatchableDisputeRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.RaiseDisputes.V4.DisputeResponse.t()}
          | {:error, AdyenEx.RaiseDisputes.V4.DefaultErrorResponseEntity.t()}
  def patch_disputes_id(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.RaiseDisputes.V4.RaiseDisputes, :patch_disputes_id},
      url: "/disputes/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.RaiseDisputes.V4.PatchableDisputeRequest, :t}}],
      response: [
        {200, {AdyenEx.RaiseDisputes.V4.DisputeResponse, :t}},
        {401, {AdyenEx.RaiseDisputes.V4.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.RaiseDisputes.V4.DefaultErrorResponseEntity, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_disputes(body :: AdyenEx.RaiseDisputes.V4.DisputeRequest.t(), opts :: keyword) ::
          {:ok, AdyenEx.RaiseDisputes.V4.DisputeResponse.t()}
          | {:error, AdyenEx.RaiseDisputes.V4.DefaultErrorResponseEntity.t()}
  def post_disputes(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.RaiseDisputes.V4.RaiseDisputes, :post_disputes},
      url: "/disputes",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.RaiseDisputes.V4.DisputeRequest, :t}}],
      response: [
        {200, {AdyenEx.RaiseDisputes.V4.DisputeResponse, :t}},
        {401, {AdyenEx.RaiseDisputes.V4.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.RaiseDisputes.V4.DefaultErrorResponseEntity, :t}},
