defmodule AdyenEx.Management.V1.SplitConfigurationMerchantLevel do
  @moduledoc """
  ...
  * Management API - SplitConfiguration read and write
  ...
  @spec delete_merchants_merchant_id_split_configurations_split_configuration_id(
          ...
          {:ok, AdyenEx.Management.V1.SplitConfiguration.t()}
  ...
  def delete_merchants_merchant_id_split_configurations_split_configuration_id(
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.Management.V1.SplitConfigurationMerchantLevel,
      ...
      method: :delete,
      response: [
        {200, {AdyenEx.Management.V1.SplitConfiguration, :t}},
        {204, :null},
  ...
  * Management API - SplitConfiguration read and write
  ...
  @spec get_merchants_merchant_id_split_configurations(merchantId :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.Management.V1.SplitConfigurationList.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def get_merchants_merchant_id_split_configurations(merchantId, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      response: [
        {200, {AdyenEx.Management.V1.SplitConfigurationList, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
        {401, {AdyenEx.Management.V1.RestServiceError, :t}},
        {403, {AdyenEx.Management.V1.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_merchants_merchant_id_split_configurations_split_configuration_id(
          merchantId :: String.t(),
          splitConfigurationId :: String.t(),
          body :: AdyenEx.Management.V1.UpdateSplitConfigurationRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.SplitConfiguration.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def patch_merchants_merchant_id_split_configurations_split_configuration_id(
    ...
    client.request(%{
      ...
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.Management.V1.UpdateSplitConfigurationRequest, :t}}],
      response: [
        {200, {AdyenEx.Management.V1.SplitConfiguration, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_merchants_merchant_id_split_configurations_split_configuration_id_rules_rule_id(
          ...
          splitConfigurationId :: String.t(),
          ruleId :: String.t(),
          body :: AdyenEx.Management.V1.UpdateSplitConfigurationRuleRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.SplitConfiguration.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def patch_merchants_merchant_id_split_configurations_split_configuration_id_rules_rule_id(
    ...
    client.request(%{
      ...
      method: :patch,
      request: [
        {"application/json", {AdyenEx.Management.V1.UpdateSplitConfigurationRuleRequest, :t}}
      ],
      response: [
        {200, {AdyenEx.Management.V1.SplitConfiguration, :t}},
        {204, :null},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_merchants_merchant_id_split_configurations_split_configuration_id_rules_rule_id_split_logic_split_logic_id(
          ...
          body :: AdyenEx.Management.V1.UpdateSplitConfigurationLogicRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.SplitConfiguration.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def patch_merchants_merchant_id_split_configurations_split_configuration_id_rules_rule_id_split_logic_split_logic_id(
    ...
    client.request(%{
      ...
      method: :patch,
      request: [
        {"application/json", {AdyenEx.Management.V1.UpdateSplitConfigurationLogicRequest, :t}}
      ],
      response: [
        {200, {AdyenEx.Management.V1.SplitConfiguration, :t}},
        {204, :null},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_merchants_merchant_id_split_configurations(
          merchantId :: String.t(),
          body :: AdyenEx.Management.V1.SplitConfiguration.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.SplitConfiguration.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def post_merchants_merchant_id_split_configurations(merchantId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Management.V1.SplitConfiguration, :t}}],
      response: [
        {200, {AdyenEx.Management.V1.SplitConfiguration, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_merchants_merchant_id_split_configurations_split_configuration_id(
          merchantId :: String.t(),
          splitConfigurationId :: String.t(),
          body :: AdyenEx.Management.V1.SplitConfigurationRule.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.SplitConfiguration.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def post_merchants_merchant_id_split_configurations_split_configuration_id(
    ...
    client.request(%{
      ...
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Management.V1.SplitConfigurationRule, :t}}],
      response: [
        {200, {AdyenEx.Management.V1.SplitConfiguration, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
