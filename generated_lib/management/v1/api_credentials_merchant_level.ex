defmodule AdyenEx.Management.V1.APICredentialsMerchantLevel do
  @moduledoc """
  ...
  * Management API—API credentials read and write
  ...
  @spec get_merchants_merchant_id_api_credentials(merchantId :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.Management.V1.ListMerchantApiCredentialsResponse.t()}
  ...
  def get_merchants_merchant_id_api_credentials(merchantId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.Management.V1.APICredentialsMerchantLevel,
         :get_merchants_merchant_id_api_credentials},
      url: "/merchants/#{merchantId}/apiCredentials",
      method: :get,
      query: query,
      response: [
        {200, {AdyenEx.Management.V1.ListMerchantApiCredentialsResponse, :t}},
        {204, :null},
  ...
  * Management API—API credentials read and write
  ...
  @spec get_merchants_merchant_id_api_credentials_api_credential_id(
          ...
          {:ok, AdyenEx.Management.V1.ApiCredential.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def get_merchants_merchant_id_api_credentials_api_credential_id(
    ...
    client.request(%{
      ...
      method: :get,
      response: [
        {200, {AdyenEx.Management.V1.ApiCredential, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
        {401, {AdyenEx.Management.V1.RestServiceError, :t}},
        {403, {AdyenEx.Management.V1.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_merchants_merchant_id_api_credentials_api_credential_id(
          merchantId :: String.t(),
          apiCredentialId :: String.t(),
          body :: AdyenEx.Management.V1.UpdateMerchantApiCredentialRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.ApiCredential.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def patch_merchants_merchant_id_api_credentials_api_credential_id(
    ...
    client.request(%{
      ...
      method: :patch,
      request: [
        {"application/json", {AdyenEx.Management.V1.UpdateMerchantApiCredentialRequest, :t}}
      ],
      response: [
        {200, {AdyenEx.Management.V1.ApiCredential, :t}},
        {204, :null},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_merchants_merchant_id_api_credentials(
          merchantId :: String.t(),
          body :: AdyenEx.Management.V1.CreateMerchantApiCredentialRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.CreateApiCredentialResponse.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def post_merchants_merchant_id_api_credentials(merchantId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :post,
      request: [
        {"application/json", {AdyenEx.Management.V1.CreateMerchantApiCredentialRequest, :t}}
      ],
      response: [
        {200, {AdyenEx.Management.V1.CreateApiCredentialResponse, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
        {401, {AdyenEx.Management.V1.RestServiceError, :t}},
        {403, {AdyenEx.Management.V1.RestServiceError, :t}},
