defmodule Adyen.Management.V1.PayoutSettingsMerchantLevel do
  @moduledoc """
  ...
  * Management API—Payout account settings read and write
  ...
  def delete_merchants_merchant_id_payout_settings_payout_settings_id(
    ...
    client.request(%{
      ...
      call:
        {Adyen.Management.V1.PayoutSettingsMerchantLevel,
  ...
  * Management API—Payout account settings read
  ...
  @spec get_merchants_merchant_id_payout_settings(merchantId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Management.V1.PayoutSettingsResponse.t()}
  ...
  def get_merchants_merchant_id_payout_settings(merchantId, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      response: [
        {200, {Adyen.Management.V1.PayoutSettingsResponse, :t}},
        {204, :null},
        {400, {Adyen.Management.V1.RestServiceError, :t}},
        {401, {Adyen.Management.V1.RestServiceError, :t}},
        {403, {Adyen.Management.V1.RestServiceError, :t}},
  ...
  * Management API—Payout account settings read
  ...
  @spec get_merchants_merchant_id_payout_settings_payout_settings_id(
          ...
          {:ok, Adyen.Management.V1.PayoutSettings.t()}
          | {:error, Adyen.Management.V1.RestServiceError.t()}
  def get_merchants_merchant_id_payout_settings_payout_settings_id(
    ...
    client.request(%{
      ...
      method: :get,
      response: [
        {200, {Adyen.Management.V1.PayoutSettings, :t}},
        {204, :null},
        {400, {Adyen.Management.V1.RestServiceError, :t}},
        {401, {Adyen.Management.V1.RestServiceError, :t}},
        {403, {Adyen.Management.V1.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_merchants_merchant_id_payout_settings_payout_settings_id(
          merchantId :: String.t(),
          payoutSettingsId :: String.t(),
          body :: Adyen.Management.V1.UpdatePayoutSettingsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Management.V1.PayoutSettings.t()}
          | {:error, Adyen.Management.V1.RestServiceError.t()}
  def patch_merchants_merchant_id_payout_settings_payout_settings_id(
    ...
    client.request(%{
      ...
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.Management.V1.UpdatePayoutSettingsRequest, :t}}],
      response: [
        {200, {Adyen.Management.V1.PayoutSettings, :t}},
        {204, :null},
        {400, {Adyen.Management.V1.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_merchants_merchant_id_payout_settings(
          merchantId :: String.t(),
          body :: Adyen.Management.V1.PayoutSettingsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Management.V1.PayoutSettings.t()}
          | {:error, Adyen.Management.V1.RestServiceError.t()}
  def post_merchants_merchant_id_payout_settings(merchantId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Management.V1.PayoutSettingsRequest, :t}}],
      response: [
        {200, {Adyen.Management.V1.PayoutSettings, :t}},
        {204, :null},
        {400, {Adyen.Management.V1.RestServiceError, :t}},
