defmodule AdyenEx.Management.V1.ClientCertificatesCompanyLevel do
  @moduledoc """
  ...
  * Management API - Client certificates read
  ...
  @spec get_companies_company_id_client_certificates(companyId :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.Management.V1.CertificateSearchResponse.t()}
  ...
  **Content Types**: `application/json`
  ...
  @spec post_companies_company_id_client_certificates(
          companyId :: String.t(),
          body :: AdyenEx.Management.V1.ClientCertificateRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.ClientCertificateWithChain.t()}
          | {:error, AdyenEx.Management.V1.DefaultErrorResponseEntity.t()}
  def post_companies_company_id_client_certificates(companyId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Management.V1.ClientCertificateRequest, :t}}],
      response: [
        {201, {AdyenEx.Management.V1.ClientCertificateWithChain, :t}},
