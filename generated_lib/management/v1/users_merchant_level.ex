defmodule AdyenEx.Management.V1.UsersMerchantLevel do
  @moduledoc """
  ...
  * Management API—Users read and write
  ...
  @spec get_merchants_merchant_id_users(merchantId :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.Management.V1.ListMerchantUsersResponse.t()}
  ...
  def get_merchants_merchant_id_users(merchantId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.Management.V1.UsersMerchantLevel, :get_merchants_merchant_id_users},
      url: "/merchants/#{merchantId}/users",
      method: :get,
      query: query,
      response: [
        {200, {AdyenEx.Management.V1.ListMerchantUsersResponse, :t}},
        {204, :null},
  ...
  * Management API—Users read and write
  ...
  @spec get_merchants_merchant_id_users_user_id(
          ...
          {:ok, AdyenEx.Management.V1.User.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def get_merchants_merchant_id_users_user_id(merchantId, userId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.Management.V1.UsersMerchantLevel, :get_merchants_merchant_id_users_user_id},
      url: "/merchants/#{merchantId}/users/#{userId}",
      method: :get,
      response: [
        {200, {AdyenEx.Management.V1.User, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
        {401, {AdyenEx.Management.V1.RestServiceError, :t}},
        {403, {AdyenEx.Management.V1.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_merchants_merchant_id_users_user_id(
          merchantId :: String.t(),
          userId :: String.t(),
          body :: AdyenEx.Management.V1.UpdateMerchantUserRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.User.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def patch_merchants_merchant_id_users_user_id(merchantId, userId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.Management.V1.UsersMerchantLevel, :patch_merchants_merchant_id_users_user_id},
      url: "/merchants/#{merchantId}/users/#{userId}",
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.Management.V1.UpdateMerchantUserRequest, :t}}],
      response: [
        {200, {AdyenEx.Management.V1.User, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_merchants_merchant_id_users(
          merchantId :: String.t(),
          body :: AdyenEx.Management.V1.CreateMerchantUserRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.CreateUserResponse.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def post_merchants_merchant_id_users(merchantId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.Management.V1.UsersMerchantLevel, :post_merchants_merchant_id_users},
      url: "/merchants/#{merchantId}/users",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Management.V1.CreateMerchantUserRequest, :t}}],
      response: [
        {200, {AdyenEx.Management.V1.CreateUserResponse, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
        {401, {AdyenEx.Management.V1.RestServiceError, :t}},
        {403, {AdyenEx.Management.V1.RestServiceError, :t}},
