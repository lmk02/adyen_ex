defmodule AdyenEx.Management.V1.AccountStoreLevel do
  @moduledoc """
  ...
  * Management API—Stores read and write
  ...
  @spec get_merchants_merchant_id_stores(merchantId :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.Management.V1.ListStoresResponse.t()}
  ...
  def get_merchants_merchant_id_stores(merchantId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.Management.V1.AccountStoreLevel, :get_merchants_merchant_id_stores},
      url: "/merchants/#{merchantId}/stores",
      method: :get,
      query: query,
      response: [
        {200, {AdyenEx.Management.V1.ListStoresResponse, :t}},
        {204, :null},
  ...
  * Management API—Stores read and write
  ...
  @spec get_merchants_merchant_id_stores_store_id(
          ...
          {:ok, AdyenEx.Management.V1.Store.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def get_merchants_merchant_id_stores_store_id(merchantId, storeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.Management.V1.AccountStoreLevel, :get_merchants_merchant_id_stores_store_id},
      url: "/merchants/#{merchantId}/stores/#{storeId}",
      method: :get,
      response: [
        {200, {AdyenEx.Management.V1.Store, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
        {401, {AdyenEx.Management.V1.RestServiceError, :t}},
        {403, {AdyenEx.Management.V1.RestServiceError, :t}},
  ...
  * Management API—Stores read and write
  ...
  def get_stores(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {AdyenEx.Management.V1.AccountStoreLevel, :get_stores},
      url: "/stores",
      method: :get,
      query: query,
      response: [
  ...
  * Management API—Stores read and write
  ...
  def get_stores_store_id(storeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.Management.V1.AccountStoreLevel, :get_stores_store_id},
      url: "/stores/#{storeId}",
      method: :get,
      response: [
        {200, {AdyenEx.Management.V1.Store, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_merchants_merchant_id_stores_store_id(
          merchantId :: String.t(),
          storeId :: String.t(),
          body :: AdyenEx.Management.V1.UpdateStoreRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.Store.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def patch_merchants_merchant_id_stores_store_id(merchantId, storeId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.Management.V1.AccountStoreLevel, :patch_merchants_merchant_id_stores_store_id},
      url: "/merchants/#{merchantId}/stores/#{storeId}",
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.Management.V1.UpdateStoreRequest, :t}}],
      response: [
        {200, {AdyenEx.Management.V1.Store, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  def patch_stores_store_id(storeId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.Management.V1.AccountStoreLevel, :patch_stores_store_id},
      url: "/stores/#{storeId}",
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.Management.V1.UpdateStoreRequest, :t}}],
  ...
  **Content Types**: `application/json`
  ...
  @spec post_merchants_merchant_id_stores(
          merchantId :: String.t(),
          body :: AdyenEx.Management.V1.StoreCreationRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.Store.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def post_merchants_merchant_id_stores(merchantId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.Management.V1.AccountStoreLevel, :post_merchants_merchant_id_stores},
      url: "/merchants/#{merchantId}/stores",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Management.V1.StoreCreationRequest, :t}}],
      response: [
        {200, {AdyenEx.Management.V1.Store, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec post_stores(
          body :: AdyenEx.Management.V1.StoreCreationWithMerchantCodeRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.Store.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def post_stores(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {AdyenEx.Management.V1.AccountStoreLevel, :post_stores},
      url: "/stores",
      body: body,
      method: :post,
      request: [
        {"application/json", {AdyenEx.Management.V1.StoreCreationWithMerchantCodeRequest, :t}}
      ],
      response: [
        {200, {AdyenEx.Management.V1.Store, :t}},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
