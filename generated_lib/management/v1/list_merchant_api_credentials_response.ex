defmodule AdyenEx.Management.V1.ListMerchantApiCredentialsResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          data: [AdyenEx.Management.V1.ApiCredential.t()] | nil,
          itemsTotal: integer,
          pagesTotal: integer
        }
  ...
  def __fields__(:t) do
    [
      ...
      data: [{AdyenEx.Management.V1.ApiCredential, :t}],
