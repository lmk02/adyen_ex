defmodule AdyenEx.Management.V1.APICredentialsCompanyLevel do
  @moduledoc """
  ...
  * Management API—API credentials read and write
  ...
  @spec get_companies_company_id_api_credentials(companyId :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.Management.V1.ListCompanyApiCredentialsResponse.t()}
  ...
  def get_companies_company_id_api_credentials(companyId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.Management.V1.APICredentialsCompanyLevel,
         :get_companies_company_id_api_credentials},
      url: "/companies/#{companyId}/apiCredentials",
      method: :get,
      query: query,
      response: [
        {200, {AdyenEx.Management.V1.ListCompanyApiCredentialsResponse, :t}},
  ...
  * Management API—API credentials read and write
  ...
  @spec get_companies_company_id_api_credentials_api_credential_id(
          ...
          {:ok, AdyenEx.Management.V1.CompanyApiCredential.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def get_companies_company_id_api_credentials_api_credential_id(
    ...
    client.request(%{
      ...
      method: :get,
      response: [
        {200, {AdyenEx.Management.V1.CompanyApiCredential, :t}},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
        {401, {AdyenEx.Management.V1.RestServiceError, :t}},
        {403, {AdyenEx.Management.V1.RestServiceError, :t}},
        {422, {AdyenEx.Management.V1.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_companies_company_id_api_credentials_api_credential_id(
          companyId :: String.t(),
          apiCredentialId :: String.t(),
          body :: AdyenEx.Management.V1.UpdateCompanyApiCredentialRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.CompanyApiCredential.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def patch_companies_company_id_api_credentials_api_credential_id(
    ...
    client.request(%{
      ...
      method: :patch,
      request: [
        {"application/json", {AdyenEx.Management.V1.UpdateCompanyApiCredentialRequest, :t}}
      ],
      response: [
        {200, {AdyenEx.Management.V1.CompanyApiCredential, :t}},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_companies_company_id_api_credentials(
          companyId :: String.t(),
          body :: AdyenEx.Management.V1.CreateCompanyApiCredentialRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V1.CreateCompanyApiCredentialResponse.t()}
          | {:error, AdyenEx.Management.V1.RestServiceError.t()}
  def post_companies_company_id_api_credentials(companyId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :post,
      request: [
        {"application/json", {AdyenEx.Management.V1.CreateCompanyApiCredentialRequest, :t}}
      ],
      response: [
        {200, {AdyenEx.Management.V1.CreateCompanyApiCredentialResponse, :t}},
        {400, {AdyenEx.Management.V1.RestServiceError, :t}},
        {401, {AdyenEx.Management.V1.RestServiceError, :t}},
        {403, {AdyenEx.Management.V1.RestServiceError, :t}},
        {422, {AdyenEx.Management.V1.RestServiceError, :t}},
