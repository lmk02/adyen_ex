defmodule AdyenEx.Management.V1.Webhook do
  @moduledoc """
  Provides struct and type for a Webhook
  """

  @type t :: %__MODULE__{
          _links: AdyenEx.Management.V1.WebhookLinks.t() | nil,
          ...
          active: boolean,
          additionalSettings: AdyenEx.Management.V1.AdditionalSettingsResponse.t() | nil,
  ...
  def __fields__(:t) do
    [
      _links: {AdyenEx.Management.V1.WebhookLinks, :t},
      acceptsExpiredCertificate: :boolean,
      acceptsSelfSignedCertificate: :boolean,
      acceptsUntrustedRootCertificate: :boolean,
      accountReference: :string,
      active: :boolean,
      additionalSettings: {AdyenEx.Management.V1.AdditionalSettingsResponse, :t},
