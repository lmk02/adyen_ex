defmodule Adyen.Management.V1.APIKeyMerchantLevel do
  @moduledoc """
  ...
  * Management API—API credentials read and write
  ...
  @spec post_merchants_merchant_id_api_credentials_api_credential_id_generate_api_key(
          ...
          {:ok, Adyen.Management.V1.GenerateApiKeyResponse.t()}
  ...
  def post_merchants_merchant_id_api_credentials_api_credential_id_generate_api_key(
    ...
    client.request(%{
      ...
      call:
        {Adyen.Management.V1.APIKeyMerchantLevel,
      ...
      method: :post,
      response: [
        {200, {Adyen.Management.V1.GenerateApiKeyResponse, :t}},
        {204, :null},
