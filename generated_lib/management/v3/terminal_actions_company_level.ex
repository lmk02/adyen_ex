defmodule Adyen.Management.V3.TerminalActionsCompanyLevel do
  @moduledoc """
  ...
  * Management API—Terminal actions read and write
  ...
  @spec get_companies_company_id_terminal_actions(companyId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Management.V3.ListExternalTerminalActionsResponse.t()}
  ...
  def get_companies_company_id_terminal_actions(companyId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.Management.V3.TerminalActionsCompanyLevel,
         :get_companies_company_id_terminal_actions},
      url: "/companies/#{companyId}/terminalActions",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.Management.V3.ListExternalTerminalActionsResponse, :t}},
  ...
  * Management API—Terminal actions read and write
  ...
  @spec get_companies_company_id_terminal_actions_action_id(
          ...
          {:ok, Adyen.Management.V3.ExternalTerminalAction.t()}
          | {:error, Adyen.Management.V3.RestServiceError.t()}
  def get_companies_company_id_terminal_actions_action_id(companyId, actionId, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      response: [
        {200, {Adyen.Management.V3.ExternalTerminalAction, :t}},
        {400, {Adyen.Management.V3.RestServiceError, :t}},
        {401, {Adyen.Management.V3.RestServiceError, :t}},
        {403, {Adyen.Management.V3.RestServiceError, :t}},
        {422, {Adyen.Management.V3.RestServiceError, :t}},
