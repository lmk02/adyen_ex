defmodule AdyenEx.Management.V3.TerminalSettingsStoreLevel do
  @moduledoc """
  ...
  * Management API—Terminal settings read and write
  ...
  def get_merchants_merchant_id_stores_reference_terminal_logos(merchantId, reference, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.Management.V3.TerminalSettingsStoreLevel,
  ...
  * Management API—Terminal settings read and write
  ...
  def get_stores_store_id_terminal_logos(storeId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.Management.V3.TerminalSettingsStoreLevel, :get_stores_store_id_terminal_logos},
  ...
  * Management API—Terminal settings Advanced read and write
  ...
  def get_stores_store_id_terminal_settings(storeId, opts \\ []) do
    ...
    client.request(%{
      args: [storeId: storeId],
      call:
        {AdyenEx.Management.V3.TerminalSettingsStoreLevel, :get_stores_store_id_terminal_settings},
  ...
  **Content Types**: `application/json`
  ...
  def patch_stores_store_id_terminal_logos(storeId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.Management.V3.TerminalSettingsStoreLevel, :patch_stores_store_id_terminal_logos},
      url: "/stores/#{storeId}/terminalLogos",
      body: body,
      method: :patch,
      query: query,
