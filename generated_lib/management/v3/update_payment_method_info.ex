defmodule AdyenEx.Management.V3.UpdatePaymentMethodInfo do
  ...
  @type t :: %__MODULE__{
          ...
          cashapp: AdyenEx.Management.V3.CashAppUpdateInfo.t() | nil,
          ...
          ebt: AdyenEx.Management.V3.EbtUpdateInfo.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      cashapp: {AdyenEx.Management.V3.CashAppUpdateInfo, :t},
      countries: [:string],
      ...
      ebt: {AdyenEx.Management.V3.EbtUpdateInfo, :t},
