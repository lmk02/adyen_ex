defmodule Adyen.Management.V3.AccountCompanyLevel do
  @moduledoc """
  ...
  * Management API—Account read
  ...
  @spec get_companies(opts :: keyword) ::
          {:ok, Adyen.Management.V3.ListCompanyResponse.t()}
  ...
  def get_companies(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.Management.V3.AccountCompanyLevel, :get_companies},
      url: "/companies",
      method: :get,
      query: query,
      response: [
        {200, {Adyen.Management.V3.ListCompanyResponse, :t}},
  ...
  * Management API—Account read
  ...
  @spec get_companies_company_id(companyId :: String.t(), opts :: keyword) ::
          {:ok, Adyen.Management.V3.Company.t()}
          | {:error, Adyen.Management.V3.RestServiceError.t()}
  def get_companies_company_id(companyId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Management.V3.AccountCompanyLevel, :get_companies_company_id},
      url: "/companies/#{companyId}",
      method: :get,
      response: [
        {200, {Adyen.Management.V3.Company, :t}},
        {400, {Adyen.Management.V3.RestServiceError, :t}},
        {401, {Adyen.Management.V3.RestServiceError, :t}},
        {403, {Adyen.Management.V3.RestServiceError, :t}},
        {422, {Adyen.Management.V3.RestServiceError, :t}},
  ...
  * Management API—Account read
  ...
  def get_companies_company_id_merchants(companyId, opts \\ []) do
    ...
    client.request(%{
      args: [companyId: companyId],
      call: {Adyen.Management.V3.AccountCompanyLevel, :get_companies_company_id_merchants},
