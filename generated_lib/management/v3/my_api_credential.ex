defmodule Adyen.Management.V3.MyAPICredential do
  @moduledoc """
  ...
  def delete_me_allowed_origins_origin_id(originId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Management.V3.MyAPICredential, :delete_me_allowed_origins_origin_id},
  ...
  @spec get_me(opts :: keyword) ::
          {:ok, Adyen.Management.V3.MeApiCredential.t()}
  ...
  def get_me(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.Management.V3.MyAPICredential, :get_me},
      url: "/me",
      method: :get,
      response: [
        {200, {Adyen.Management.V3.MeApiCredential, :t}},
        {400, {Adyen.Management.V3.RestServiceError, :t}},
        {401, {Adyen.Management.V3.RestServiceError, :t}},
        {403, {Adyen.Management.V3.RestServiceError, :t}},
        {422, {Adyen.Management.V3.RestServiceError, :t}},
  ...
  def get_me_allowed_origins(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.Management.V3.MyAPICredential, :get_me_allowed_origins},
  ...
  def get_me_allowed_origins_origin_id(originId, opts \\ []) do
    ...
    client.request(%{
      args: [originId: originId],
      call: {Adyen.Management.V3.MyAPICredential, :get_me_allowed_origins_origin_id},
      url: "/me/allowedOrigins/#{originId}",
      method: :get,
      response: [
  ...
  **Content Types**: `application/json`
  ...
  @spec post_me_allowed_origins(
          body :: Adyen.Management.V3.CreateAllowedOriginRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Management.V3.AllowedOrigin.t()}
          | {:error, Adyen.Management.V3.RestServiceError.t()}
  def post_me_allowed_origins(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Adyen.Management.V3.MyAPICredential, :post_me_allowed_origins},
      url: "/me/allowedOrigins",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Management.V3.CreateAllowedOriginRequest, :t}}],
      response: [
        {200, {Adyen.Management.V3.AllowedOrigin, :t}},
        {400, {Adyen.Management.V3.RestServiceError, :t}},
        {401, {Adyen.Management.V3.RestServiceError, :t}},
  ...
  * Management API—API credentials read and write
  ...
  @spec post_me_generate_client_key(opts :: keyword) ::
          {:ok, Adyen.Management.V3.GenerateClientKeyResponse.t()}
          | {:error, Adyen.Management.V3.RestServiceError.t()}
  def post_me_generate_client_key(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Adyen.Management.V3.MyAPICredential, :post_me_generate_client_key},
      url: "/me/generateClientKey",
      method: :post,
      response: [
        {200, {Adyen.Management.V3.GenerateClientKeyResponse, :t}},
        {400, {Adyen.Management.V3.RestServiceError, :t}},
        {401, {Adyen.Management.V3.RestServiceError, :t}},
        {403, {Adyen.Management.V3.RestServiceError, :t}},
        {422, {Adyen.Management.V3.RestServiceError, :t}},
