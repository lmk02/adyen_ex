defmodule AdyenEx.Management.V3.DonationCampaigns do
  @moduledoc """
  ...
  * Management API—Campaign Management read and write
  ...
  @spec delete_companies_company_id_campaign_management_donation_campaign_id(
          ...
          opts :: keyword
        ) :: :ok | {:error, AdyenEx.Management.V3.DefaultErrorResponseEntity.t()}
  def delete_companies_company_id_campaign_management_donation_campaign_id(
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.Management.V3.DonationCampaigns,
      ...
      response: [
        ...
        {503, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}}
      ],
      opts: opts
    })
  end
  ...
  * Management API—Campaign Management read and write
  ...
  @spec get_companies_company_id_campaign_management_account_holders_account_holder_id(
          ...
          {:ok, AdyenEx.Management.V3.ListDonationCampaignsResponse.t()}
  ...
  def get_companies_company_id_campaign_management_account_holders_account_holder_id(
    ...
    client.request(%{
      ...
      query: query,
      response: [
        {200, {AdyenEx.Management.V3.ListDonationCampaignsResponse, :t}},
        {400, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}},
        {401, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}},
        {422, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_companies_company_id_campaign_management_donation_campaign_id(
          companyId :: String.t(),
          donationCampaignId :: String.t(),
          body :: AdyenEx.Management.V3.DonationCampaignUpdate.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V3.DonationCampaign.t()}
          | {:error, AdyenEx.Management.V3.DefaultErrorResponseEntity.t()}
  def patch_companies_company_id_campaign_management_donation_campaign_id(
    ...
    client.request(%{
      ...
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.Management.V3.DonationCampaignUpdate, :t}}],
      response: [
        {200, {AdyenEx.Management.V3.DonationCampaign, :t}},
        {400, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}},
        {401, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}},
        {422, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_companies_company_id_campaign_management(
          companyId :: String.t(),
          body :: AdyenEx.Management.V3.DonationCampaignRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V3.DonationCampaign.t()}
          | {:error, AdyenEx.Management.V3.DefaultErrorResponseEntity.t()}
  def post_companies_company_id_campaign_management(companyId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.Management.V3.DonationCampaigns, :post_companies_company_id_campaign_management},
      url: "/companies/#{companyId}/campaignManagement",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Management.V3.DonationCampaignRequest, :t}}],
      response: [
        {200, {AdyenEx.Management.V3.DonationCampaign, :t}},
        {400, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}},
        {401, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_companies_company_id_nonprofits(
          companyId :: String.t(),
          body :: AdyenEx.Management.V3.ListNonprofitsRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V3.ListNonprofitsResponse.t()}
          | {:error, AdyenEx.Management.V3.DefaultErrorResponseEntity.t()}
  def post_companies_company_id_nonprofits(companyId, body, opts \\ []) do
    ...
    client.request(%{
      args: [companyId: companyId, body: body],
      call: {AdyenEx.Management.V3.DonationCampaigns, :post_companies_company_id_nonprofits},
      url: "/companies/#{companyId}/nonprofits",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {AdyenEx.Management.V3.ListNonprofitsRequest, :t}}],
      response: [
        {200, {AdyenEx.Management.V3.ListNonprofitsResponse, :t}},
        {400, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}},
        {401, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}},
        {403, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}},
        {422, {AdyenEx.Management.V3.DefaultErrorResponseEntity, :t}},
