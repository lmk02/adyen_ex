defmodule AdyenEx.Management.V3.PaymentMethodsMerchantLevel do
  @moduledoc """
  ...
  * Management API—Payment methods read
  ...
  @spec get_merchants_merchant_id_payment_method_settings(
          ...
          {:ok, AdyenEx.Management.V3.PaymentMethodResponse.t()}
  ...
  def get_merchants_merchant_id_payment_method_settings(merchantId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.Management.V3.PaymentMethodsMerchantLevel,
         :get_merchants_merchant_id_payment_method_settings},
      url: "/merchants/#{merchantId}/paymentMethodSettings",
      method: :get,
      query: query,
      response: [
        {200, {AdyenEx.Management.V3.PaymentMethodResponse, :t}},
        {204, :null},
        ...
        {429, {AdyenEx.Management.V3.RestServiceError, :t}},
  ...
  * Management API—Payment methods read
  ...
  @spec get_merchants_merchant_id_payment_method_settings_payment_method_id(
          ...
          {:ok, AdyenEx.Management.V3.PaymentMethod.t()}
          | {:error, AdyenEx.Management.V3.RestServiceError.t()}
  def get_merchants_merchant_id_payment_method_settings_payment_method_id(
    ...
    client.request(%{
      ...
      method: :get,
      response: [
        {200, {AdyenEx.Management.V3.PaymentMethod, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V3.RestServiceError, :t}},
        {401, {AdyenEx.Management.V3.RestServiceError, :t}},
        {403, {AdyenEx.Management.V3.RestServiceError, :t}},
  ...
  * Management API—Payment methods read
  ...
  @spec get_merchants_merchant_id_payment_method_settings_payment_method_id_get_apple_pay_domains(
          ...
          {:ok, AdyenEx.Management.V3.ApplePayResponseInfo.t()}
          | {:error, AdyenEx.Management.V3.RestServiceError.t()}
  def get_merchants_merchant_id_payment_method_settings_payment_method_id_get_apple_pay_domains(
    ...
    client.request(%{
      ...
      method: :get,
      response: [
        {200, {AdyenEx.Management.V3.ApplePayResponseInfo, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V3.RestServiceError, :t}},
        {401, {AdyenEx.Management.V3.RestServiceError, :t}},
        {403, {AdyenEx.Management.V3.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_merchants_merchant_id_payment_method_settings_payment_method_id(
          merchantId :: String.t(),
          paymentMethodId :: String.t(),
          body :: AdyenEx.Management.V3.UpdatePaymentMethodInfo.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V3.PaymentMethod.t()}
          | {:error, AdyenEx.Management.V3.RestServiceError.t()}
  def patch_merchants_merchant_id_payment_method_settings_payment_method_id(
    ...
    client.request(%{
      ...
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.Management.V3.UpdatePaymentMethodInfo, :t}}],
      response: [
        {200, {AdyenEx.Management.V3.PaymentMethod, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V3.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_merchants_merchant_id_payment_method_settings(
          merchantId :: String.t(),
          body :: AdyenEx.Management.V3.PaymentMethodSetupInfo.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V3.PaymentMethod.t()}
          | {:error, AdyenEx.Management.V3.RestServiceError.t()}
  def post_merchants_merchant_id_payment_method_settings(merchantId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Management.V3.PaymentMethodSetupInfo, :t}}],
      response: [
        {200, {AdyenEx.Management.V3.PaymentMethod, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V3.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_merchants_merchant_id_payment_method_settings_payment_method_id_add_apple_pay_domains(
          merchantId :: String.t(),
          paymentMethodId :: String.t(),
          body :: AdyenEx.Management.V3.ApplePayInfo.t(),
          opts :: keyword
  ...
  def post_merchants_merchant_id_payment_method_settings_payment_method_id_add_apple_pay_domains(
    ...
    client.request(%{
      ...
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Management.V3.ApplePayInfo, :t}}],
      response: [
        {204, :null},
        {400, {AdyenEx.Management.V3.RestServiceError, :t}},
        {401, {AdyenEx.Management.V3.RestServiceError, :t}},
