defmodule AdyenEx.Management.V3.WebhooksCompanyLevel do
  @moduledoc """
  ...
  * Management API—Webhooks read and write
  ...
  def delete_companies_company_id_webhooks_webhook_id(companyId, webhookId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.Management.V3.WebhooksCompanyLevel,
  ...
  * Management API—Webhooks read and write
  ...
  @spec get_companies_company_id_webhooks(companyId :: String.t(), opts :: keyword) ::
          {:ok, AdyenEx.Management.V3.ListWebhooksResponse.t()}
  ...
  def get_companies_company_id_webhooks(companyId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.Management.V3.WebhooksCompanyLevel, :get_companies_company_id_webhooks},
      url: "/companies/#{companyId}/webhooks",
      method: :get,
      query: query,
      response: [
        {200, {AdyenEx.Management.V3.ListWebhooksResponse, :t}},
        {400, {AdyenEx.Management.V3.RestServiceError, :t}},
        {401, {AdyenEx.Management.V3.RestServiceError, :t}},
        {403, {AdyenEx.Management.V3.RestServiceError, :t}},
        {422, {AdyenEx.Management.V3.RestServiceError, :t}},
  ...
  * Management API—Webhooks read and write
  ...
  @spec get_companies_company_id_webhooks_webhook_id(
          ...
          {:ok, AdyenEx.Management.V3.Webhook.t()}
          | {:error, AdyenEx.Management.V3.RestServiceError.t()}
  def get_companies_company_id_webhooks_webhook_id(companyId, webhookId, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      response: [
        {200, {AdyenEx.Management.V3.Webhook, :t}},
        {400, {AdyenEx.Management.V3.RestServiceError, :t}},
        {401, {AdyenEx.Management.V3.RestServiceError, :t}},
        {403, {AdyenEx.Management.V3.RestServiceError, :t}},
        {422, {AdyenEx.Management.V3.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_companies_company_id_webhooks_webhook_id(
          companyId :: String.t(),
          webhookId :: String.t(),
          body :: AdyenEx.Management.V3.UpdateCompanyWebhookRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V3.Webhook.t()}
          | {:error, AdyenEx.Management.V3.RestServiceError.t()}
  def patch_companies_company_id_webhooks_webhook_id(companyId, webhookId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      body: body,
      method: :patch,
      request: [{"application/json", {AdyenEx.Management.V3.UpdateCompanyWebhookRequest, :t}}],
      response: [
        {200, {AdyenEx.Management.V3.Webhook, :t}},
        {400, {AdyenEx.Management.V3.RestServiceError, :t}},
        {401, {AdyenEx.Management.V3.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_companies_company_id_webhooks(
          companyId :: String.t(),
          body :: AdyenEx.Management.V3.CreateCompanyWebhookRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V3.Webhook.t()}
          | {:error, AdyenEx.Management.V3.RestServiceError.t()}
  def post_companies_company_id_webhooks(companyId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {AdyenEx.Management.V3.WebhooksCompanyLevel, :post_companies_company_id_webhooks},
      url: "/companies/#{companyId}/webhooks",
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Management.V3.CreateCompanyWebhookRequest, :t}}],
      response: [
        {200, {AdyenEx.Management.V3.Webhook, :t}},
        {400, {AdyenEx.Management.V3.RestServiceError, :t}},
        {401, {AdyenEx.Management.V3.RestServiceError, :t}},
  ...
  * Management API—Webhooks read and write
  ...
  @spec post_companies_company_id_webhooks_webhook_id_generate_hmac(
          ...
          {:ok, AdyenEx.Management.V3.GenerateHmacKeyResponse.t()}
          | {:error, AdyenEx.Management.V3.RestServiceError.t()}
  def post_companies_company_id_webhooks_webhook_id_generate_hmac(
    ...
    client.request(%{
      ...
      method: :post,
      response: [
        {200, {AdyenEx.Management.V3.GenerateHmacKeyResponse, :t}},
        {400, {AdyenEx.Management.V3.RestServiceError, :t}},
        {401, {AdyenEx.Management.V3.RestServiceError, :t}},
        {403, {AdyenEx.Management.V3.RestServiceError, :t}},
        {422, {AdyenEx.Management.V3.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_companies_company_id_webhooks_webhook_id_test(
          companyId :: String.t(),
          webhookId :: String.t(),
          body :: AdyenEx.Management.V3.TestCompanyWebhookRequest.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V3.TestWebhookResponse.t()}
          | {:error, AdyenEx.Management.V3.RestServiceError.t()}
  def post_companies_company_id_webhooks_webhook_id_test(companyId, webhookId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Management.V3.TestCompanyWebhookRequest, :t}}],
      response: [
        {200, {AdyenEx.Management.V3.TestWebhookResponse, :t}},
        {400, {AdyenEx.Management.V3.RestServiceError, :t}},
        {401, {AdyenEx.Management.V3.RestServiceError, :t}},
        {403, {AdyenEx.Management.V3.RestServiceError, :t}},
        {422, {AdyenEx.Management.V3.RestServiceError, :t}},
