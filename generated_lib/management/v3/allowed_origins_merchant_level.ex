defmodule AdyenEx.Management.V3.AllowedOriginsMerchantLevel do
  @moduledoc """
  ...
  * Management API—API credentials read and write
  ...
  def delete_merchants_merchant_id_api_credentials_api_credential_id_allowed_origins_origin_id(
    ...
    client.request(%{
      ...
      call:
        {AdyenEx.Management.V3.AllowedOriginsMerchantLevel,
  ...
  **Content Types**: `application/json`
  ...
  @spec post_merchants_merchant_id_api_credentials_api_credential_id_allowed_origins(
          merchantId :: String.t(),
          apiCredentialId :: String.t(),
          body :: AdyenEx.Management.V3.AllowedOrigin.t(),
          opts :: keyword
        ) ::
          {:ok, AdyenEx.Management.V3.AllowedOrigin.t()}
          | {:error, AdyenEx.Management.V3.RestServiceError.t()}
  def post_merchants_merchant_id_api_credentials_api_credential_id_allowed_origins(
    ...
    client.request(%{
      ...
      body: body,
      method: :post,
      request: [{"application/json", {AdyenEx.Management.V3.AllowedOrigin, :t}}],
      response: [
        {200, {AdyenEx.Management.V3.AllowedOrigin, :t}},
        {204, :null},
        {400, {AdyenEx.Management.V3.RestServiceError, :t}},
