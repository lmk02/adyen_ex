defmodule Adyen.Management.V3.WebhooksMerchantLevel do
  @moduledoc """
  ...
  * Management API—Webhooks read and write
  ...
  def delete_merchants_merchant_id_webhooks_webhook_id(merchantId, webhookId, opts \\ []) do
    ...
    client.request(%{
      ...
      call:
        {Adyen.Management.V3.WebhooksMerchantLevel,
  ...
  * Management API—Webhooks read and write
  ...
  def get_merchants_merchant_id_webhooks(merchantId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Management.V3.WebhooksMerchantLevel, :get_merchants_merchant_id_webhooks},
  ...
  **Content Types**: `application/json`
  ...
  @spec patch_merchants_merchant_id_webhooks_webhook_id(
          merchantId :: String.t(),
          webhookId :: String.t(),
          body :: Adyen.Management.V3.UpdateMerchantWebhookRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Management.V3.Webhook.t()}
          | {:error, Adyen.Management.V3.RestServiceError.t()}
  def patch_merchants_merchant_id_webhooks_webhook_id(merchantId, webhookId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      body: body,
      method: :patch,
      request: [{"application/json", {Adyen.Management.V3.UpdateMerchantWebhookRequest, :t}}],
      response: [
        {200, {Adyen.Management.V3.Webhook, :t}},
        {204, :null},
        {400, {Adyen.Management.V3.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_merchants_merchant_id_webhooks(
          merchantId :: String.t(),
          body :: Adyen.Management.V3.CreateMerchantWebhookRequest.t(),
          opts :: keyword
        ) ::
          {:ok, Adyen.Management.V3.Webhook.t()}
          | {:error, Adyen.Management.V3.RestServiceError.t()}
  def post_merchants_merchant_id_webhooks(merchantId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Adyen.Management.V3.WebhooksMerchantLevel, :post_merchants_merchant_id_webhooks},
      url: "/merchants/#{merchantId}/webhooks",
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Management.V3.CreateMerchantWebhookRequest, :t}}],
      response: [
        {200, {Adyen.Management.V3.Webhook, :t}},
        {204, :null},
        {400, {Adyen.Management.V3.RestServiceError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  @spec post_merchants_merchant_id_webhooks_webhook_id_test(
          merchantId :: String.t(),
          webhookId :: String.t(),
          body :: Adyen.Management.V3.TestWebhookRequest.t(),
          opts :: keyword
        ) ::
  ...
  def post_merchants_merchant_id_webhooks_webhook_id_test(merchantId, webhookId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      body: body,
      method: :post,
      request: [{"application/json", {Adyen.Management.V3.TestWebhookRequest, :t}}],
      response: [
